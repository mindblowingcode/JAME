...
import net.sf.jame.contextfree.swing.extensions.editor.ShapeAdjustmentReferenceElementListEditorRuntime;

/**
 * @author Andrea Medeghini
 */
public class ShapeAdjustmentReferenceElementListEditorDescriptor extends EditorExtensionDescriptor {
	/**
