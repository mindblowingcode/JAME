...
import net.sf.jame.mandelbrot.extensions.renderingFormula.Z3Runtime;
import net.sf.jame.mandelbrot.extensions.renderingFormula.Z3Config;

/**
 * @author Andrea Medeghini
 */
public class Z3Descriptor extends RenderingFormulaExtensionDescriptor {
	/**
