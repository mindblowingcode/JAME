...
public class RenderedPaletteDescriptorRuntime extends DescriptorExtensionRuntime {
	...
	public ProcessorDescriptor createDescriptor(String elementName, String defaultValue, ProcessorCardinality cardinality) {
		return new ProcessorDescriptor(elementName, "RenderedPalette", RenderedPaletteElement.CLASS_ID, "net.sf.jame.mandelbrot.common", "RenderedPaletteElement", null, null, null, null, null, null, null, null, null, null, null, null, "net.sf.jame.mandelbrot.util", "RenderedPalette", defaultValue, "get", "set", cardinality);
	}
	...
	public String getClassId() {
		return RenderedPaletteElement.CLASS_ID;
	}
}
