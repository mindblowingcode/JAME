 ...
 */
public class DRFConfigXMLImporterDescriptor extends ExtensionConfigXMLImporterExtensionDescriptor {
	/**
	 ...
	 */
	public DRFConfigXMLImporterRuntime getExtensionRuntime() {
		return new DRFConfigXMLImporterRuntime();
	}
}
