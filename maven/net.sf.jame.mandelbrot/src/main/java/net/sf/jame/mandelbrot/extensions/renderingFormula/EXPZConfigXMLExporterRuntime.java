 ...
 */
public class EXPZConfigXMLExporterRuntime extends ExtensionConfigXMLExporterExtensionRuntime {
	/**
	 * @see net.sf.jame.core.extensionConfigXMLExporter.extension.ExtensionConfigXMLExporterExtensionRuntime#createXMLExporter()
	 */
	@Override
	public XMLExporter<EXPZConfig> createXMLExporter() {
		return new EXPZConfigXMLExporter();
	}

	private class EXPZConfigXMLExporter extends AbstractRenderingFormulaConfigXMLExporter<EXPZConfig> {
		/**
