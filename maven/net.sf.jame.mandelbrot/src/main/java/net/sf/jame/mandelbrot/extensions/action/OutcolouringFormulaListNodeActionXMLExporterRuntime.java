 ...
 */
public class OutcolouringFormulaListNodeActionXMLExporterRuntime extends AbstractConfigElementListNodeActionXMLExporterRuntime<OutcolouringFormulaConfigElement> {
	/**
