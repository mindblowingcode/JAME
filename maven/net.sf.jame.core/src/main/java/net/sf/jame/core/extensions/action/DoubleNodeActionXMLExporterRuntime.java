 ...
 */
public class DoubleNodeActionXMLExporterRuntime extends AbstractActionXMLExporterRuntime {
	/**
	...
	protected void exportParams(final NodeActionValue action, final Element element, final XMLNodeBuilder builder) throws XMLExportException {
		final DoubleElementXMLExporter exporter = new DoubleElementXMLExporter();
		final DoubleElement configElement0 = new DoubleElement((Double) action.getActionParams()[0]);
		final DoubleElement configElement1 = new DoubleElement((Double) action.getActionParams()[1]);
