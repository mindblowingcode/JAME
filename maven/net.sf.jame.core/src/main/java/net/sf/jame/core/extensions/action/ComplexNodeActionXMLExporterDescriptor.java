...
import net.sf.jame.core.extensions.action.ComplexNodeActionXMLExporterRuntime;

/**
 * @author Andrea Medeghini
 */
public class ComplexNodeActionXMLExporterDescriptor extends ActionXMLExporterExtensionDescriptor {
	/**
