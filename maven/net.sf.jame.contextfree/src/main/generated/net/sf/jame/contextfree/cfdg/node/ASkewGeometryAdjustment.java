...
public final class ASkewGeometryAdjustment extends PGeometryAdjustment
{
    ...
    public Object clone()
    {
        return new ASkewGeometryAdjustment(
    ...
    {
        ((Analysis) sw).caseASkewGeometryAdjustment(this);
    }
