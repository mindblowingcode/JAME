...
import net.sf.jame.contextfree.extensions.pathReplacement.LineRelPathReplacementRuntime;
import net.sf.jame.contextfree.extensions.pathReplacement.LineRelPathReplacementConfig;

/**
 * @author Andrea Medeghini
 */
public class LineRelPathReplacementDescriptor extends PathReplacementExtensionDescriptor {
	/**
