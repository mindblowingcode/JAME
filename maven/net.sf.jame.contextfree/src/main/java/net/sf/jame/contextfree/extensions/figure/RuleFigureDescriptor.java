 ...
 */
public class RuleFigureDescriptor extends FigureExtensionDescriptor {
	/**
	 ...
	 */
	public RuleFigureRuntime getExtensionRuntime() {
		return new RuleFigureRuntime();
	}
	 ...
	 */
	public RuleFigureConfig getExtensionConfig() {
