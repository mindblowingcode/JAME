...
public class FontDescriptorRuntime extends DescriptorExtensionRuntime {
	...
	public ProcessorDescriptor createDescriptor(String elementName, String defaultValue, ProcessorCardinality cardinality) {
		return new ProcessorDescriptor(elementName, "Font", FontElement.CLASS_ID, "net.sf.jame.core.common", "FontElement", null, null, null, null, null, null, null, null, null, null, null, null, "java.awt", "Font", defaultValue, "get", "set", cardinality);
	}
