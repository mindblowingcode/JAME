...
public class ComplexDescriptorRuntime extends DescriptorExtensionRuntime {
	...
	public ProcessorDescriptor createDescriptor(String elementName, String defaultValue, ProcessorCardinality cardinality) {
		return new ProcessorDescriptor(elementName, "Complex", ComplexElement.CLASS_ID, "net.sf.jame.core.common", "ComplexElement", null, null, null, null, null, null, null, null, null, null, null, null, "net.sf.jame.core.math", "Complex", defaultValue, "get", "set", cardinality);
	}
	...
	public String getClassId() {
		return ComplexElement.CLASS_ID;
	}
}
