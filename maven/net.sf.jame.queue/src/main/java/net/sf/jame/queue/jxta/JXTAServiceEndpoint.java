...
public class JXTAServiceEndpoint implements ServiceEndpoint {
	...
	/**
	 * @see net.sf.jame.queue.network.ServiceEndpoint#invalidate()
	 */
	...
	/**
	 * @see net.sf.jame.queue.network.ServiceEndpoint#isInvalidated()
	 */
	...
	/**
	 * @see net.sf.jame.queue.network.ServiceEndpoint#setJobCount(int)
	 */
	...
	/**
	 * @see net.sf.jame.queue.network.ServiceEndpoint#getJobCount()
	 */
	...
	/**
	 * @see net.sf.jame.queue.network.ServiceEndpoint#getJobCountLastUpdate()
	 */
