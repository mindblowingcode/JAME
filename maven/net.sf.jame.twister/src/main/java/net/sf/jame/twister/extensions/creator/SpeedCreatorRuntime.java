...
public class SpeedCreatorRuntime extends CreatorExtensionRuntime {
	...
	public Object create(final Object... args) throws JSException {
		try {
			return new Speed(new DoubleVector4D(((Double[]) args[0])[0], ((Double[]) args[0])[1], ((Double[]) args[0])[2], ((Double[]) args[0])[3]), new DoubleVector4D(((Double[]) args[1])[0], ((Double[]) args[1])[1], ((Double[]) args[1])[2], ((Double[]) args[1])[3]));
		}
		catch (Exception e) {
			throw new JSException("Speed creator requires two arguments: #1 of type Number[], #2 of type Number[]", e);
		}
	}
}
