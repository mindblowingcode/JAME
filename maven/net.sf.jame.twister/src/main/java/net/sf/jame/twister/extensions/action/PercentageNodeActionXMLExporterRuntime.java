...
public class PercentageNodeActionXMLExporterRuntime extends AbstractActionXMLExporterRuntime {
	...
	protected void exportParams(final NodeActionValue action, final Element element, final XMLNodeBuilder builder) throws XMLExportException {
		final PercentageElementXMLExporter exporter = new PercentageElementXMLExporter();
		final PercentageElement configElement0 = new PercentageElement((Integer) action.getActionParams()[0]);
		final PercentageElement configElement1 = new PercentageElement((Integer) action.getActionParams()[1]);
