 ...
 */
public class EffectConfigElementNodeValue extends NodeValue<EffectConfigElement> {
	private static final long serialVersionUID = 1L;

	/**
	 * @param value
	 */
	public EffectConfigElementNodeValue(final EffectConfigElement value) {
		super(value);
	}
	...
	public EffectConfigElementNodeValue clone() {
		return new EffectConfigElementNodeValue(getValueClone());
	}
}
