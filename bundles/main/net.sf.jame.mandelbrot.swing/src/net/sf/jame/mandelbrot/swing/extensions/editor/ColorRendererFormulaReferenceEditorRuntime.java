 ...
 */
public class ColorRendererFormulaReferenceEditorRuntime extends ReferenceEditorRuntime {
	/**
	...
	protected ExtensionComboBoxModel createModel() {
		return new ExtensionComboBoxModel(MandelbrotRegistry.getInstance().getColorRendererFormulaRegistry(), true);
	}
	...
	protected NodeValue<?> createNodeValue(final ExtensionReference reference) {
		// return new ColorRendererFormulaExtensionReferenceNodeValue(reference != null ? reference.clone() : null);
		return new ColorRendererFormulaExtensionReferenceNodeValue(reference);
	}
}
