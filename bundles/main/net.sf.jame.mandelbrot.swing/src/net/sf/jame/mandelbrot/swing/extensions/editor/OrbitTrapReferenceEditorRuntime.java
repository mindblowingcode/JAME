...
import net.sf.jame.mandelbrot.fractal.orbittrap.OrbitTrapExtensionReferenceNodeValue;

/**
 * @author Andrea Medeghini
 */
public class OrbitTrapReferenceEditorRuntime extends ConfigurableReferenceEditorRuntime {
	/**
	...
	protected ConfigurableExtensionComboBoxModel createModel() {
		return new ConfigurableExtensionComboBoxModel(MandelbrotRegistry.getInstance().getOrbitTrapRegistry(), true);
	}
	...
	protected NodeValue createNodeValue(final ConfigurableExtensionReference reference) {
		return new OrbitTrapExtensionReferenceNodeValue(reference);
	}
}
