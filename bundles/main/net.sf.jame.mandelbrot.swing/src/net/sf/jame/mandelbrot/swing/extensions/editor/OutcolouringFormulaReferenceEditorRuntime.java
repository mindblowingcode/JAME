...
import net.sf.jame.mandelbrot.fractal.outcolouring.OutcolouringFormulaExtensionReferenceNodeValue;

/**
 * @author Andrea Medeghini
 */
public class OutcolouringFormulaReferenceEditorRuntime extends ConfigurableReferenceEditorRuntime {
	/**
	...
	protected NodeValue createNodeValue(final ConfigurableExtensionReference reference) {
		// return new OutcolouringFormulaExtensionReferenceNodeValue(reference != null ? reference.clone() : null);
		return new OutcolouringFormulaExtensionReferenceNodeValue(reference);
	}
}
