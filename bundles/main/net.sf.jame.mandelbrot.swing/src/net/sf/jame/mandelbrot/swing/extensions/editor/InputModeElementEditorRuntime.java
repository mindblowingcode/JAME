...
public class InputModeElementEditorRuntime extends EditorExtensionRuntime {
	...
	private class EditorComponent extends JPanel implements NodeEditorComponent {
		...
		public EditorComponent(final NodeEditor nodeEditor) {
			...
			modeComboBox = GUIFactory.createComboBox(new ModeComboBoxModel(), MandelbrotSwingExtensionResources.getInstance().getString("tooltip.inputMode"));
	...
	private class ModeComboBoxModel extends DefaultComboBoxModel {
		...
		public ModeComboBoxModel() {
			addElement(new Object[] { "Zoom", new Integer(0) });
			addElement(new Object[] { "Select", new Integer(1) });
		}
	}
