...
import net.sf.jame.contextfree.cfdg.pathAdjustment.PathAdjustmentExtensionReferenceNodeValue;
 ...
 */
public class PathAdjustmentReferenceEditorRuntime extends ConfigurableReferenceEditorRuntime {
	/**
	...
	protected NodeValue createNodeValue(final ConfigurableExtensionReference reference) {
		return new PathAdjustmentExtensionReferenceNodeValue(reference);
	}
}
