...
public class StrokeJoinElementEditorRuntime extends EditorExtensionRuntime {
	...
	private class EditorComponent extends JPanel implements NodeEditorComponent {
		...
		public EditorComponent(final NodeEditor nodeEditor) {
			...
			ruleComboBox = GUIFactory.createComboBox(new StrokeJoinComboBoxModel(), ContextFreeSwingExtensionResources.getInstance().getString("tooltip.strokeJoin"));
			ruleComboBox.setRenderer(new StrokeJoinListCellRenderer());
			ruleComboBox.setSelectedItem((((StrokeJoinElementNodeValue) nodeEditor.getNodeValue()).getValue()));
