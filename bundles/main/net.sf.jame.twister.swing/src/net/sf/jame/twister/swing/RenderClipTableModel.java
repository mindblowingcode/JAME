...
import net.sf.jame.service.clip.ClipPreview;
...
public class RenderClipTableModel extends ServiceAdapter implements TableModel {
	private static final Logger logger = Logger.getLogger(RenderClipTableModel.class);
	...
	public void reload() {
		service.execute(new ServiceCallback<List<RenderClipDataRow>>() {
			...
			public void executed(final List<RenderClipDataRow> clips) {
				try {
					if (RenderClipTableModel.logger.isInfoEnabled()) {
			...
			public void failed(final Throwable throwable) {
				try {
					RenderClipTableModel.logger.error("Reload failed", throwable);
					GUIUtil.executeTask(new Runnable() {
							public void run() {
	...
	/**
	 * @see net.sf.jame.twister.swing.ServiceAdapter#clipCreated(net.sf.jame.service.clip.RenderClipDataRow)
	 */
	@Override
	...
	/**
	 * @see net.sf.jame.twister.swing.ServiceAdapter#clipDeleted(net.sf.jame.service.clip.RenderClipDataRow)
	 */
	@Override
	...
	/**
	 * @see net.sf.jame.twister.swing.ServiceAdapter#clipUpdated(net.sf.jame.service.clip.RenderClipDataRow)
	 */
	@Override
