...
public class ShapeConfigElementNodeValue extends NodeValue<ShapeConfigElement> {
	 ...
	 */
	@Override
	public ShapeConfigElement getValueClone() {
		if (getValue() != null) {
	 ...
	 */
	@Override
	public ShapeConfigElementNodeValue clone() {
		return new ShapeConfigElementNodeValue(getValueClone());
	}
}
