...
public class ShapeReplacementConfigElementXMLExporter extends XMLExporter<ShapeReplacementConfigElement> {
	...
	private void exportName(final ShapeReplacementConfigElement configElement, final Element element, final XMLNodeBuilder builder) throws XMLExportException {
		element.appendChild(new StringElementXMLExporter().exportToElement(configElement.getNameElement(), builder));
	}
	private void exportShapeAdjustmentListElement(final ShapeReplacementConfigElement configElement, final Element element, final XMLNodeBuilder builder) throws XMLExportException {
