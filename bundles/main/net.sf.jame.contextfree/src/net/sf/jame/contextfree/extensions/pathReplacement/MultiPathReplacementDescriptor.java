 ...
 */
public class MultiPathReplacementDescriptor extends PathReplacementExtensionDescriptor {
	/**
	 ...
	 */
	public MultiPathReplacementRuntime getExtensionRuntime() {
		return new MultiPathReplacementRuntime();
	}
	 ...
	 */
	public MultiPathReplacementConfig getExtensionConfig() {
