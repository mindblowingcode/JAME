 ...
 */
public class QuadToPathReplacementConfig extends PathReplacementExtensionConfig {
	...
	public boolean equals(final Object obj) {
		...
		final QuadToPathReplacementConfig other = (QuadToPathReplacementConfig) obj;
		if (xElement == null) {
	 ...
	 */
	@Override
	public QuadToPathReplacementConfig clone() {
		final QuadToPathReplacementConfig config = new QuadToPathReplacementConfig();
		config.setX(getX());
		config.setY(getY());
		config.setX1(getX1());
		config.setY1(getY1());
