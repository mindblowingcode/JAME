...
public class FlipPathAdjustmentConfigXMLExporterRuntime extends ExtensionConfigXMLExporterExtensionRuntime {
	...
	private class FlipPathAdjustmentConfigXMLExporter extends XMLExporter<FlipPathAdjustmentConfig> {
		...
		private void exportFlipX(final FlipPathAdjustmentConfig extensionConfig, final Element element, final XMLNodeBuilder builder) throws XMLExportException {
			element.appendChild(new FloatElementXMLExporter().exportToElement(extensionConfig.getFlipXElement(), builder));
		}
		private void exportFlipY(final FlipPathAdjustmentConfig extensionConfig, final Element element, final XMLNodeBuilder builder) throws XMLExportException {
