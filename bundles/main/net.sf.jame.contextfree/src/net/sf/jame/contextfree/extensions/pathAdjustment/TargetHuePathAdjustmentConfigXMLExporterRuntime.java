...
public class TargetHuePathAdjustmentConfigXMLExporterRuntime extends ExtensionConfigXMLExporterExtensionRuntime {
	...
	public XMLExporter<TargetHuePathAdjustmentConfig> createXMLExporter() {
		return new TargetHuePathAdjustmentConfigXMLExporter();
	}

	private class TargetHuePathAdjustmentConfigXMLExporter extends XMLExporter<TargetHuePathAdjustmentConfig> {
		 ...
		 */
		@Override
		public Element exportToElement(final TargetHuePathAdjustmentConfig extensionConfig, final XMLNodeBuilder builder) throws XMLExportException {
		 ...
		 */
		protected void exportProperties(final TargetHuePathAdjustmentConfig extensionConfig, final Element element, final XMLNodeBuilder builder) throws ExtensionException, XMLExportException {
			exportValue(extensionConfig, createProperty(builder, element, "value"), builder);
		}
	
		private void exportValue(final TargetHuePathAdjustmentConfig extensionConfig, final Element element, final XMLNodeBuilder builder) throws XMLExportException {
