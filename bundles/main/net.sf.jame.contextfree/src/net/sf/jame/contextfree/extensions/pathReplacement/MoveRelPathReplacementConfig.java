 ...
 */
public class MoveRelPathReplacementConfig extends PathReplacementExtensionConfig {
	...
	public boolean equals(final Object obj) {
		...
		final MoveRelPathReplacementConfig other = (MoveRelPathReplacementConfig) obj;
		if (xElement == null) {
	 ...
	 */
	@Override
	public MoveRelPathReplacementConfig clone() {
		final MoveRelPathReplacementConfig config = new MoveRelPathReplacementConfig();
		config.setX(getX());
		config.setY(getY());
		return config;
	}
