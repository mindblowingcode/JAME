...
public class FigureConfigElementNode extends AbstractConfigElementNode<FigureConfigElement> {
	...
	protected void createChildNodes(final FigureConfigElementNodeValue value) {
		removeAllChildNodes();
		appendChildNode(new NameElementNode(FigureConfigElementNode.NODE_ID + ".name", value.getValue()));
	...
	private static class NameElementNode extends StringElementNode {
		 ...
		 * @param figure
		 */
		public NameElementNode(final String nodeId, final FigureConfigElement figure) {
			super(nodeId, figure.getNameElement());
