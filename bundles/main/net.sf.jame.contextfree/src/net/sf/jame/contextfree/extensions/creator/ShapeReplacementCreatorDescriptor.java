...
import net.sf.jame.contextfree.extensions.creator.ShapeReplacementCreatorRuntime;

/**
 * @author Andrea Medeghini
 */
public class ShapeReplacementCreatorDescriptor extends CreatorExtensionDescriptor {
	/**
