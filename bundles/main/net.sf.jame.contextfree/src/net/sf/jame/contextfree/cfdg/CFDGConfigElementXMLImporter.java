...
public class CFDGConfigElementXMLImporter extends XMLImporter<CFDGConfigElement> {
	...
	protected void importProperties(final CFDGConfigElement configElement, final List<Element> propertyElements) throws ExtensionException, XMLImportException {
		...
		importX(configElement, propertyElements.get(2));
		importY(configElement, propertyElements.get(3));
		importWidth(configElement, propertyElements.get(4));
		importHeight(configElement, propertyElements.get(5));
		importTileWidth(configElement, propertyElements.get(6));
		importTileHeight(configElement, propertyElements.get(7));
		importBackground(configElement, propertyElements.get(8));
		importFigureListElement(configElement, propertyElements.get(9));
	}
