...
public class CFDGConfigElementXMLImporter extends XMLImporter<CFDGConfigElement> {
	...
	protected void importProperties(final CFDGConfigElement configElement, final List<Element> propertyElements) throws ExtensionException, XMLImportException {
		...
		importUseSize(configElement, propertyElements.get(2));
		importUseTile(configElement, propertyElements.get(3));
		importX(configElement, propertyElements.get(4));
		importY(configElement, propertyElements.get(5));
		importWidth(configElement, propertyElements.get(6));
		importHeight(configElement, propertyElements.get(7));
		importTileWidth(configElement, propertyElements.get(8));
		importTileHeight(configElement, propertyElements.get(9));
		importBackground(configElement, propertyElements.get(10));
		importFigureListElement(configElement, propertyElements.get(11));
	}
