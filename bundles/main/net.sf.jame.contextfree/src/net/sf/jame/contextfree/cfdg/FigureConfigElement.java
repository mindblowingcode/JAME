 ...
 */
public abstract class FigureConfigElement extends AbstractConfigElement {
	private static final long serialVersionUID = 1L;
	protected final StringElement nameElement = new StringElement("");

	/**
	 * Constructs a new element.
	 */
	public FigureConfigElement(String classId) {
		super(classId);
	}
