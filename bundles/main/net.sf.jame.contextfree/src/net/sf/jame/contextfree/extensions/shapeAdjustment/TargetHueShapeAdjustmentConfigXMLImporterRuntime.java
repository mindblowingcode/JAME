...
public class TargetHueShapeAdjustmentConfigXMLImporterRuntime extends ExtensionConfigXMLImporterExtensionRuntime {
	...
	public XMLImporter<TargetHueShapeAdjustmentConfig> createXMLImporter() {
		return new TargetHueShapeAdjustmentConfigXMLImporter();
	}

	private class TargetHueShapeAdjustmentConfigXMLImporter extends XMLImporter<TargetHueShapeAdjustmentConfig> {
		...
		public TargetHueShapeAdjustmentConfig importFromElement(final Element element) throws XMLImportException {
			...
			final TargetHueShapeAdjustmentConfig extensionConfig = this.createExtensionConfig();
		 ...
		 */
		protected void importProperties(final TargetHueShapeAdjustmentConfig extensionConfig, final List<Element> propertyElements) throws ExtensionException, XMLImportException {
			importValue(extensionConfig, propertyElements.get(0));
		}
	
		private void importValue(final TargetHueShapeAdjustmentConfig extensionConfig, final Element element) throws XMLImportException {
