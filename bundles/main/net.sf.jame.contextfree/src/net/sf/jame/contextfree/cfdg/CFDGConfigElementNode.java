...
public class CFDGConfigElementNode extends AbstractConfigElementNode<CFDGConfigElement> {
	...
	private static class FigureListElementNode extends AbstractConfigElementListNode<FigureConfigElement> {
		 ...
		 */
		@Override
		protected AbstractConfigElementNode<? extends FigureConfigElement> createChildNode(final FigureConfigElement value) {
			if (value.getClassId().equals(RuleConfigElement.CLASS_ID)) {
				return new RuleConfigElementNode((RuleConfigElement) value);
			} else if (value.getClassId().equals(PathConfigElement.CLASS_ID)) {
				return new PathConfigElementNode((PathConfigElement) value);
			}
			return null;
		}
