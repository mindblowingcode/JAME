...
import net.sf.jame.contextfree.cfdg.shape.adjustment.ShapeAdjustmentConfigElementXMLExporter;
...
public class LoopShapeReplacementConfigElementXMLExporter extends XMLExporter<LoopShapeReplacementConfigElement> {
	/**
	 * @see net.sf.jame.core.xml.XMLExporter#exportToElement(java.lang.Object, net.sf.jame.core.xml.XMLNodeBuilder)
	 */
	@Override
	public Element exportToElement(final LoopShapeReplacementConfigElement configElement, final XMLNodeBuilder builder) throws XMLExportException {
		final Element element = this.createElement(builder, LoopShapeReplacementConfigElement.CLASS_ID);
		try {
	 ...
	 */
	protected void exportProperties(final LoopShapeReplacementConfigElement configElement, final Element element, final XMLNodeBuilder builder) throws ExtensionException, XMLExportException {
	...
	private void exportTimes(final LoopShapeReplacementConfigElement configElement, final Element element, final XMLNodeBuilder builder) throws XMLExportException {
		element.appendChild(new IntegerElementXMLExporter().exportToElement(configElement.getTimesElement(), builder));
	}
	private void exportShapeAdjustmentListElement(final LoopShapeReplacementConfigElement configElement, final Element element, final XMLNodeBuilder builder) throws XMLExportException {
	...
	private void exportShapeSingleElement(final LoopShapeReplacementConfigElement configElement, final Element element, final XMLNodeBuilder builder) throws XMLExportException {
