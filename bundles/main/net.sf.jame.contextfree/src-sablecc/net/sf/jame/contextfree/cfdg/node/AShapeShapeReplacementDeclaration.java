...
public final class AShapeShapeReplacementDeclaration extends PShapeReplacementDeclaration
{
    private PShapeReplacement _shapeReplacement_;

    public AShapeShapeReplacementDeclaration()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AShapeShapeReplacementDeclaration(
            cloneNode(this._shapeReplacement_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAShapeShapeReplacementDeclaration(this);
    }
