...
public final class AParametersPathAdjustment extends PPathAdjustment
{
    private TParametersToken _parametersToken_;
    private TString _string_;

    public AParametersPathAdjustment()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AParametersPathAdjustment(
    ...
    {
        ((Analysis) sw).caseAParametersPathAdjustment(this);
    }
