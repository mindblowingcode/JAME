...
public final class AListMultiShapeReplacementBody extends PMultiShapeReplacementBody
{
    private PListShapeReplacement _listShapeReplacement_;

    public AListMultiShapeReplacementBody()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AListMultiShapeReplacementBody(
            cloneNode(this._listShapeReplacement_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAListMultiShapeReplacementBody(this);
    }
