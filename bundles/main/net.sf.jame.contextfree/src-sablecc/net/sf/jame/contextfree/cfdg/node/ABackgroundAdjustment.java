...
public final class ABackgroundAdjustment extends PBackgroundAdjustment
{
    private PSimpleColorAdjustment _simpleColorAdjustment_;

    public ABackgroundAdjustment()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ABackgroundAdjustment(
            cloneNode(this._simpleColorAdjustment_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseABackgroundAdjustment(this);
    }
