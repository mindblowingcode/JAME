...
public final class AShapeDeclaration extends PShapeDeclaration
{
    private PListShapeReplacement _listShapeReplacement_;

    public AShapeDeclaration()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AShapeDeclaration(
            cloneNode(this._listShapeReplacement_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAShapeDeclaration(this);
    }
