...
public final class ASinglePathReplacementDeclaration extends PPathReplacementDeclaration
{
    private PPathReplacement _pathReplacement_;

    public ASinglePathReplacementDeclaration()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ASinglePathReplacementDeclaration(
            cloneNode(this._pathReplacement_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseASinglePathReplacementDeclaration(this);
    }
