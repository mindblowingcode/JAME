...
public final class ASize2PathAdjustment extends PPathAdjustment
{
    ...
    public Object clone()
    {
        return new ASize2PathAdjustment(
    ...
    {
        ((Analysis) sw).caseASize2PathAdjustment(this);
    }
