...
public final class AYGeometryAdjustment extends PGeometryAdjustment
{
    private TYToken _yToken_;
    private PExpression _expression_;

    public AYGeometryAdjustment()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AYGeometryAdjustment(
    ...
    {
        ((Analysis) sw).caseAYGeometryAdjustment(this);
    }
