...
public final class AXGeometryAdjustment extends PGeometryAdjustment
{
    private TXToken _xToken_;
    private PExpression _expression_;

    public AXGeometryAdjustment()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AXGeometryAdjustment(
    ...
    {
        ((Analysis) sw).caseAXGeometryAdjustment(this);
    }
