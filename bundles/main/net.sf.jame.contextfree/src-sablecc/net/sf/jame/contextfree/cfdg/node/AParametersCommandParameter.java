...
public final class AParametersCommandParameter extends PCommandParameter
{
    private TParametersToken _parametersToken_;
    private TString _string_;

    public AParametersCommandParameter()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AParametersCommandParameter(
    ...
    {
        ((Analysis) sw).caseAParametersCommandParameter(this);
    }
