...
public final class APathLoopPathOperationBody extends PLoopPathOperationBody
{
    private PPathOperation _pathOperation_;

    public APathLoopPathOperationBody()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new APathLoopPathOperationBody(
            cloneNode(this._pathOperation_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAPathLoopPathOperationBody(this);
    }
