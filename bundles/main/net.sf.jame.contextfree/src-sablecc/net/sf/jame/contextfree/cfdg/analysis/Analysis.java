...
public interface Analysis extends Switch
{
    ...
    void caseAShapeDeclaration(AShapeDeclaration node);
    void caseAPathDeclaration(APathDeclaration node);
    void caseALoopShapeReplacementDeclaration(ALoopShapeReplacementDeclaration node);
    void caseAShapeShapeReplacementDeclaration(AShapeShapeReplacementDeclaration node);
    void caseADefaultShapeReplacement(ADefaultShapeReplacement node);
    void caseAOrderedShapeReplacement(AOrderedShapeReplacement node);
    void caseAListShapeReplacement(AListShapeReplacement node);
    void caseALoopShapeReplacement(ALoopShapeReplacement node);
    void caseAShapeLoopShapeReplacementBody(AShapeLoopShapeReplacementBody node);
    void caseAListLoopShapeReplacementBody(AListLoopShapeReplacementBody node);
    ...
    void caseALoopPathOperationDeclaration(ALoopPathOperationDeclaration node);
    ...
    void caseALoopPathOperation(ALoopPathOperation node);
    void caseAPathLoopPathOperationBody(APathLoopPathOperationBody node);
    void caseAListLoopPathOperationBody(AListLoopPathOperationBody node);
