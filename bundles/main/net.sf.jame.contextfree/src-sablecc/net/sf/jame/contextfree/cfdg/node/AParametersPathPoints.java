...
public final class AParametersPathPoints extends PPathPoints
{
    private TParametersToken _parametersToken_;
    private TString _string_;

    public AParametersPathPoints()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AParametersPathPoints(
    ...
    {
        ((Analysis) sw).caseAParametersPathPoints(this);
    }
