...
public final class AListShapeReplacement extends PListShapeReplacement
{
    ...
    public Object clone()
    {
        return new AListShapeReplacement(
    ...
    {
        ((Analysis) sw).caseAListShapeReplacement(this);
    }
