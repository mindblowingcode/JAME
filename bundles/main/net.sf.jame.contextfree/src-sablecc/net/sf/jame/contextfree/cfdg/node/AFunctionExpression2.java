...
public final class AFunctionExpression2 extends PExpression2
{
    private PFunction _function_;

    public AFunctionExpression2()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AFunctionExpression2(
            cloneNode(this._function_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAFunctionExpression2(this);
    }
