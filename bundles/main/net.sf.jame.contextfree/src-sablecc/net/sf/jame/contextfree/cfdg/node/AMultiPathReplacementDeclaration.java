...
public final class AMultiPathReplacementDeclaration extends PPathReplacementDeclaration
{
    ...
    private final LinkedList<PGeometryAdjustment> _geometryAdjustment_ = new LinkedList<PGeometryAdjustment>();
    ...
    public AMultiPathReplacementDeclaration(
        ...
        @SuppressWarnings("hiding") List<PGeometryAdjustment> _geometryAdjustment_,
    ...
    public Object clone()
    {
        return new AMultiPathReplacementDeclaration(
            ...
            cloneList(this._geometryAdjustment_),
    ...
    public LinkedList<PGeometryAdjustment> getGeometryAdjustment()
    {
        return this._geometryAdjustment_;
    }

    public void setGeometryAdjustment(List<PGeometryAdjustment> list)
    {
        this._geometryAdjustment_.clear();
        this._geometryAdjustment_.addAll(list);
        for(PGeometryAdjustment e : list)
        {
            if(e.parent() != null)
            {
    ...
    void removeChild(@SuppressWarnings("unused") Node child)
    {
        ...
        if(this._geometryAdjustment_.remove(child))
        {
            return;
        }
    ...
    void replaceChild(@SuppressWarnings("unused") Node oldChild, @SuppressWarnings("unused") Node newChild)
    {
        ...
        for(ListIterator<PGeometryAdjustment> i = this._geometryAdjustment_.listIterator(); i.hasNext();)
        {
            if(i.next() == oldChild)
            {
                if(newChild != null)
                {
                    i.set((PGeometryAdjustment) newChild);
