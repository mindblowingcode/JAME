...
public final class AMultiPathOperation extends PMultiPathOperation
{
    ...
    private PMultiPathOperationBody _multiPathOperationBody_;

    public AMultiPathOperation()
    {
        // Constructor
    }
    ...
    public AMultiPathOperation(
        ...
        @SuppressWarnings("hiding") PMultiPathOperationBody _multiPathOperationBody_)
    {
        // Constructor
        setNumber(_number_);
        ...
        setMultiPathOperationBody(_multiPathOperationBody_);
    ...
    public Object clone()
    {
        return new AMultiPathOperation(
            cloneNode(this._number_),
            cloneNode(this._star_),
            cloneNode(this._lCbkt_),
            cloneList(this._pathAdjustment_),
            cloneNode(this._rCbkt_),
            cloneNode(this._multiPathOperationBody_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAMultiPathOperation(this);
    }
    ...
    public PMultiPathOperationBody getMultiPathOperationBody()
    {
        return this._multiPathOperationBody_;
    }

    public void setMultiPathOperationBody(PMultiPathOperationBody node)
    {
        if(this._multiPathOperationBody_ != null)
        {
            this._multiPathOperationBody_.parent(null);
        }
        ...
        this._multiPathOperationBody_ = node;
    }
    ...
    public String toString()
    {
        return ""
            ...
            + toString(this._multiPathOperationBody_);
    }
    ...
    void removeChild(@SuppressWarnings("unused") Node child)
    {
        ...
        if(this._multiPathOperationBody_ == child)
        {
            this._multiPathOperationBody_ = null;
            return;
        }
    ...
    void replaceChild(@SuppressWarnings("unused") Node oldChild, @SuppressWarnings("unused") Node newChild)
    {
        ...
        if(this._multiPathOperationBody_ == oldChild)
        {
            setMultiPathOperationBody((PMultiPathOperationBody) newChild);
            return;
        }
