...
public final class APathPathOperationDeclaration extends PPathOperationDeclaration
{
    private PPathOperation _pathOperation_;

    public APathPathOperationDeclaration()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new APathPathOperationDeclaration(
            cloneNode(this._pathOperation_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAPathPathOperationDeclaration(this);
    }
