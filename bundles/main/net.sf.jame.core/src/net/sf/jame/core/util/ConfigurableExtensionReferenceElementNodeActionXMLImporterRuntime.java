 ...
 */
public abstract class ConfigurableExtensionReferenceElementNodeActionXMLImporterRuntime<V extends ExtensionConfig> extends AbstractActionXMLImporterRuntime {
	private final ConfigurableExtensionRegistry<? extends ConfigurableExtensionRuntime<?>, V> registry;

	/**
	 * 
	 */
	public ConfigurableExtensionReferenceElementNodeActionXMLImporterRuntime(final ConfigurableExtensionRegistry<? extends ConfigurableExtensionRuntime<?>, V> registry) {
