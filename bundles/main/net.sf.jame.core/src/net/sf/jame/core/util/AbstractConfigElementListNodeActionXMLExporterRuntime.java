 ...
 */
public abstract class AbstractConfigElementListNodeActionXMLExporterRuntime<T extends ConfigElement> extends AbstractActionXMLExporterRuntime {
	/**
	...
	protected void exportParams(final NodeActionValue action, final Element element, final XMLNodeBuilder builder) throws XMLExportException {
		...
		final IntegerElementXMLExporter indexExporter = new IntegerElementXMLExporter();
		...
		element.appendChild(indexExporter.exportToElement(configElement0, builder));
