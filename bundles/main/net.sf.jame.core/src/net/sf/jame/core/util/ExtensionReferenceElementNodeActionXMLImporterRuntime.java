 ...
 */
public class ExtensionReferenceElementNodeActionXMLImporterRuntime extends AbstractActionXMLImporterRuntime {
	private final ExtensionRegistry<? extends ExtensionRuntime> registry;

	/**
	 * @param registry
	 */
	public ExtensionReferenceElementNodeActionXMLImporterRuntime(final ExtensionRegistry<? extends ExtensionRuntime> registry) {
