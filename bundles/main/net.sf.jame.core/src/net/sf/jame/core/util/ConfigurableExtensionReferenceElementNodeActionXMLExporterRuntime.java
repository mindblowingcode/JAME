 ...
 */
public abstract class ConfigurableExtensionReferenceElementNodeActionXMLExporterRuntime<V extends ExtensionConfig> extends AbstractActionXMLExporterRuntime {
	/**
