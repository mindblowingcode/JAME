 ...
 */
public class StringNodeActionXMLExporterRuntime extends AbstractActionXMLExporterRuntime {
	/**
	...
	protected void exportParams(final NodeActionValue action, final Element element, final XMLNodeBuilder builder) throws XMLExportException {
		final StringElementXMLExporter exporter = new StringElementXMLExporter();
		final StringElement configElement0 = new StringElement((String) action.getActionParams()[0]);
		final StringElement configElement1 = new StringElement((String) action.getActionParams()[1]);
