 ...
 */
public class BooleanElementXMLImporter extends ValueConfigElementXMLImporter<Boolean, BooleanElement> {
	/**
	 ...
	 */
	@Override
	protected BooleanElement createDefaultConfigElement() {
