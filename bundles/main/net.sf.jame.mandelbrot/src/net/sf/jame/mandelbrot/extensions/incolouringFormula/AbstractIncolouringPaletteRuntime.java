...
public abstract class AbstractIncolouringPaletteRuntime<T extends AbstractIncolouringPaletteConfig> extends AbstractIncolouringFormulaRuntime<T> {
	...
	/**
	 * @see net.sf.jame.mandelbrot.extensions.incolouringFormula.AbstractIncolouringFormulaRuntime#prepareForRendering(net.sf.jame.mandelbrot.renderingFormula.extension.RenderingFormulaExtensionRuntime, int)
	 */
	@Override
