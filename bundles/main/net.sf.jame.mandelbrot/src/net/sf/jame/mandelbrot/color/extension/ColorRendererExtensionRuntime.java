 ...
 *
 */
package net.sf.jame.mandelbrot.color.extension;
 ...
 */
public abstract class ColorRendererExtensionRuntime<T extends ColorRendererExtensionConfig> extends ConfigurableExtensionRuntime<T> {
	/**
	 * 
	 */
