 ...
 */
public class ColorRuntime extends AbstractOutcolouringFormulaRuntime<ColorConfig> {
	private int color;
	...
	/**
	 * @see net.sf.jame.mandelbrot.fractal.outcolouring.extension.OutcolouringFormulaExtensionRuntime#renderColor(double, double, double, double, int, int)
	 */
	@Override
