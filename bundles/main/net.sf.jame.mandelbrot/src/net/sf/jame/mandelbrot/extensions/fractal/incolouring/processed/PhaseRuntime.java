...
import net.sf.jame.mandelbrot.extensions.fractal.incolouring.AbstractIncolouringPaletteRuntime;
import net.sf.jame.mandelbrot.renderer.RenderedPoint;

/**
 * @author Andrea Medeghini
 */
public class PhaseRuntime extends AbstractIncolouringPaletteRuntime<PhaseConfig> {
