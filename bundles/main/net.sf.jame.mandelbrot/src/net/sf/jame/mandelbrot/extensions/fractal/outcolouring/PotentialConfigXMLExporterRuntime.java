 ...
 */
public class PotentialConfigXMLExporterRuntime extends ExtensionConfigXMLExporterExtensionRuntime {
	/**
	 * @see net.sf.jame.core.xml.extension.ExtensionConfigXMLExporterExtensionRuntime#createXMLExporter()
	 */
	@Override
	public XMLExporter<PotentialConfig> createXMLExporter() {
		return new PotentialConfigXMLExporter();
	}

	private class PotentialConfigXMLExporter extends AbstractOutcolouringPaletteConfigXMLExporter<PotentialConfig> {
		/**
