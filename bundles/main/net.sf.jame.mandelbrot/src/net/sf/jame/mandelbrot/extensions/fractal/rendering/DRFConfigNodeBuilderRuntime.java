 ...
 */
public class DRFConfigNodeBuilderRuntime extends AbstractRenderingFormulaConfigNodeBuilderRuntime {
	/**
	 * @see net.sf.jame.mandelbrot.extensions.fractal.rendering.AbstractRenderingFormulaConfigNodeBuilderRuntime#createNodes(net.sf.jame.core.tree.Node, net.sf.jame.mandelbrot.fractal.rendering.extension.RenderingFormulaExtensionConfig)
	 */
	@Override
	public void createNodes(final Node parentNode, final RenderingFormulaExtensionConfig config) {
		parentNode.appendChildNode(new ExponentNode((DRFConfig) config));
	}
	...
	private class ExponentNode extends DoubleElementNode {
		 ...
		 * @param config
		 */
		public ExponentNode(final DRFConfig config) {
