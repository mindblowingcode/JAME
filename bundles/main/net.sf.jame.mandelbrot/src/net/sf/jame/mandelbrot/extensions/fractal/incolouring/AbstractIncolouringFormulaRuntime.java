...
public abstract class AbstractIncolouringFormulaRuntime<T extends IncolouringFormulaExtensionConfig> extends IncolouringFormulaExtensionRuntime<T> {
	/**
	 * @see net.sf.jame.mandelbrot.fractal.incolouring.extension.IncolouringFormulaExtensionRuntime#isHorizontalSymetryAllowed()
	 */
	@Override
	...
	/**
	 * @see net.sf.jame.mandelbrot.fractal.incolouring.extension.IncolouringFormulaExtensionRuntime#isVerticalSymetryAllowed()
	 */
	@Override
	...
	/**
	 * @see net.sf.jame.mandelbrot.fractal.incolouring.extension.IncolouringFormulaExtensionRuntime#isSolidGuessAllowed()
	 */
	@Override
