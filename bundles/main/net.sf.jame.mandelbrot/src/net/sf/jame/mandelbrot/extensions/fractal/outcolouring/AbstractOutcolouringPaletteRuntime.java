...
public abstract class AbstractOutcolouringPaletteRuntime<T extends AbstractOutcolouringPaletteConfig> extends AbstractOutcolouringFormulaRuntime<T> {
	...
	/**
	 * @see net.sf.jame.mandelbrot.fractal.outcolouring.extension.OutcolouringFormulaExtensionRuntime#prepareForRendering(net.sf.jame.mandelbrot.fractal.rendering.extension.RenderingFormulaExtensionRuntime, int)
	 */
	@Override
