...
import net.sf.jame.mandelbrot.extensions.transformingFormula.YRuntime;
import net.sf.jame.mandelbrot.extensions.transformingFormula.YConfig;

/**
 * @author Andrea Medeghini
 */
public class YDescriptor extends TransformingFormulaExtensionDescriptor {
	/**
	 ...
	 */
	public YRuntime getExtensionRuntime() {
		return new YRuntime();
	}
	 ...
	 */
	public YConfig getExtensionConfig() {
		return new YConfig();
	}
}
