 ...
 */
public class NEWTON3ConfigXMLExporterRuntime extends ExtensionConfigXMLExporterExtensionRuntime {
	/**
	 * @see net.sf.jame.core.xml.extension.ExtensionConfigXMLExporterExtensionRuntime#createXMLExporter()
	 */
	@Override
	public XMLExporter<NEWTON3Config> createXMLExporter() {
		return new NEWTON3ConfigXMLExporter();
	}

	private class NEWTON3ConfigXMLExporter extends AbstractRenderingFormulaConfigXMLExporter<NEWTON3Config> {
		/**
