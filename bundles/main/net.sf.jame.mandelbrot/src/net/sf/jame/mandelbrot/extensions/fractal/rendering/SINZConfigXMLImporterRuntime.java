 ...
 */
public class SINZConfigXMLImporterRuntime extends ExtensionConfigXMLImporterExtensionRuntime {
	/**
	 * @see net.sf.jame.core.xml.extension.ExtensionConfigXMLImporterExtensionRuntime#createXMLImporter()
	 */
	@Override
	public XMLImporter<SINZConfig> createXMLImporter() {
		return new SINZConfigXMLImporter();
	}

	private class SINZConfigXMLImporter extends AbstractRenderingFormulaConfigXMLImporter<SINZConfig> {
		/**
		 * @see net.sf.jame.mandelbrot.extensions.fractal.rendering.AbstractRenderingFormulaConfigXMLImporter#createExtensionConfig()
		 */
		@Override
		protected SINZConfig createExtensionConfig() {
