 ...
 */
public class ColorRendererFormulaConfigElement extends AbstractConfigElement implements ReferenceElement {
	private static final long serialVersionUID = 1L;
	public static final String CLASS_ID = "ColorRendererFormula";
	private final ExtensionReferenceElement extensionElement = new ExtensionReferenceElement();

	/**
	 * Constructs a new element.
	 */
	public ColorRendererFormulaConfigElement() {
		super(ColorRendererFormulaConfigElement.CLASS_ID);
	}
	 ...
	 */
	@Override
	public ColorRendererFormulaConfigElement clone() {
		final ColorRendererFormulaConfigElement element = new ColorRendererFormulaConfigElement();
	...
	public void copyFrom(ConfigElement source) {
		ColorRendererFormulaConfigElement element = (ColorRendererFormulaConfigElement) source;
	...
	public boolean equals(final Object obj) {
		...
		final ColorRendererFormulaConfigElement other = (ColorRendererFormulaConfigElement) obj;
