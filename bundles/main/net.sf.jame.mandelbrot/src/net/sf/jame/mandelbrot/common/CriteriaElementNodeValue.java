 ...
 */
public class CriteriaElementNodeValue extends NodeValue<Integer> {
	private static final long serialVersionUID = 1L;

	/**
	 * @param value
	 */
	public CriteriaElementNodeValue(final Integer value) {
		super(value);
	}
	...
	public CriteriaElementNodeValue clone() {
		return new CriteriaElementNodeValue(getValueClone());
	}
}
