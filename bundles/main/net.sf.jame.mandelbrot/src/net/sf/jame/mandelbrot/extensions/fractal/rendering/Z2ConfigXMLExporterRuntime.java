 ...
 */
public class Z2ConfigXMLExporterRuntime extends ExtensionConfigXMLExporterExtensionRuntime {
	/**
	 * @see net.sf.jame.core.xml.extension.ExtensionConfigXMLExporterExtensionRuntime#createXMLExporter()
	 */
	@Override
	public XMLExporter<Z2Config> createXMLExporter() {
		return new Z2ConfigXMLExporter();
	}

	private class Z2ConfigXMLExporter extends AbstractRenderingFormulaConfigXMLExporter<Z2Config> {
		/**
