 ...
 */
public class RenderedPaletteElementNodeValue extends NodeValue<RenderedPalette> {
	private static final long serialVersionUID = 1L;

	/**
	 * @param value
	 */
	public RenderedPaletteElementNodeValue(final RenderedPalette value) {
		super(value);
	}
	...
	public RenderedPaletteElementNodeValue clone() {
		return new RenderedPaletteElementNodeValue(getValueClone());
	}
}
