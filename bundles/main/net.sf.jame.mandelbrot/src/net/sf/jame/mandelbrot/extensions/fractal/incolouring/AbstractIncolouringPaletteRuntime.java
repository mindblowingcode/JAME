 ...
 */
public abstract class AbstractIncolouringPaletteRuntime<T extends AbstractIncolouringPaletteConfig> extends AbstractIncolouringFormulaRuntime<T> {
	...
	/**
	 * @see net.sf.jame.mandelbrot.extensions.fractal.incolouring.AbstractIncolouringFormulaRuntime#prepareForRendering(net.sf.jame.mandelbrot.fractal.rendering.extension.RenderingFormulaExtensionRuntime, int)
	 */
	@Override
