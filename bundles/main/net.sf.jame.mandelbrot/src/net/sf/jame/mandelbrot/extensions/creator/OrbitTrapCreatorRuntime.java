 ...
 */
public class OrbitTrapCreatorRuntime extends CreatorExtensionRuntime {
	/**
	...
	public Object create(final Object... args) throws JSException {
		if ((args != null) && (args.length > 0)) {
			throw new JSException("OrbitTrapConfigElement creator requires no arguments");
		}
		return new OrbitTrapConfigElement();
	}
}
