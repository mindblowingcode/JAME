 ...
 */
public class NEWTON3Config extends AbstractRenderingFormulaConfig {
	private static final long serialVersionUID = 1L;

	/**
	 * @see net.sf.jame.mandelbrot.fractal.rendering.extension.RenderingFormulaExtensionConfig#isMandelbrotModeAllowed()
	 */
	@Override
	 ...
	 */
	@Override
	public NEWTON3Config clone() {
		final NEWTON3Config config = new NEWTON3Config();
