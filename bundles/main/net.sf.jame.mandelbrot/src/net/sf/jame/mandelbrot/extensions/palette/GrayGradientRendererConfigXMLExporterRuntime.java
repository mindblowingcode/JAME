...
public class GrayGradientRendererConfigXMLExporterRuntime extends ExtensionConfigXMLExporterExtensionRuntime {
	...
	private class GrayGradientRendererConfigXMLExporter extends AbstractPaletteRendererConfigXMLExporter<GrayGradientRendererConfig> {
		/**
		 * @see net.sf.jame.mandelbrot.extensions.palette.AbstractPaletteRendererConfigXMLExporter#getConfigElementClassId()
		 */
		@Override
		...
		/**
		 * @see net.sf.jame.mandelbrot.extensions.palette.AbstractPaletteRendererConfigXMLExporter#exportProperties(net.sf.jame.mandelbrot.palette.extension.PaletteRendererExtensionConfig, org.w3c.dom.Element, net.sf.jame.core.xml.XMLNodeBuilder)
		 */
		@Override
