 ...
 */
public class SINZConfigXMLExporterRuntime extends ExtensionConfigXMLExporterExtensionRuntime {
	/**
	...
	public XMLExporter<SINZConfig> createXMLExporter() {
		return new SINZConfigXMLExporter();
	}

	private class SINZConfigXMLExporter extends AbstractRenderingFormulaConfigXMLExporter<SINZConfig> {
		/**
