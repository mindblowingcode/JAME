...
import net.sf.jame.mandelbrot.color.ColorRendererConfigElementXMLExporter;
...
public class UniversalConfigXMLExporterRuntime extends ExtensionConfigXMLExporterExtensionRuntime {
	...
	private class UniversalConfigXMLExporter extends AbstractIncolouringPaletteConfigXMLExporter<UniversalConfig> {
		/**
		 * @see net.sf.jame.mandelbrot.extensions.fractal.incolouring.AbstractIncolouringFormulaConfigXMLExporter#getConfigElementClassId()
		 */
		@Override
		...
		/**
		 * @see net.sf.jame.mandelbrot.extensions.fractal.incolouring.AbstractIncolouringFormulaConfigXMLExporter#exportProperties(net.sf.jame.mandelbrot.fractal.incolouring.extension.IncolouringFormulaExtensionConfig, org.w3c.dom.Element, net.sf.jame.core.xml.XMLNodeBuilder)
		 */
		@Override
