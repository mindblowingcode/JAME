...
public class BinaryAndPotentialRuntime extends AbstractOutcolouringPaletteRuntime<BinaryAndPotentialConfig> {
	...
	/**
	 * @see net.sf.jame.mandelbrot.fractal.outcolouring.extension.OutcolouringFormulaExtensionRuntime#renderIndex(net.sf.jame.mandelbrot.renderer.RenderedPoint)
	 */
	@Override
