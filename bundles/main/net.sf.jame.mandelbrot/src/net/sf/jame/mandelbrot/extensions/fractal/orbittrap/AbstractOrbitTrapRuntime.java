 ...
 */
public abstract class AbstractOrbitTrapRuntime<T extends OrbitTrapExtensionConfig> extends OrbitTrapExtensionRuntime<T> {
	protected DoubleVector2D center;

	/**
	 * @see net.sf.jame.mandelbrot.fractal.orbittrap.extension.OrbitTrapExtensionRuntime#prepareForProcessing(net.sf.jame.core.util.DoubleVector2D, double, double)
	 */
	@Override
