...
public class DefaultRendererRuntime extends AbstractPaletteRendererRuntime<DefaultRendererConfig> {
	...
	/**
	 * @see net.sf.jame.mandelbrot.palette.extension.PaletteRendererExtensionRuntime#prepareForRendering()
	 */
	@Override
	...
	/**
	 * @see net.sf.jame.mandelbrot.palette.extension.PaletteRendererExtensionRuntime#renderPalette()
	 */
	@Override
