...
import net.sf.jame.mandelbrot.extensions.fractal.outcolouring.AbstractOutcolouringPaletteConfig;
import net.sf.jame.mandelbrot.extensions.fractal.outcolouring.AbstractOutcolouringPaletteConfigNodeBuilderRuntime;
...
public class BinaryAndPotentialConfigNodeBuilderRuntime extends AbstractOutcolouringPaletteConfigNodeBuilderRuntime {
	/**
	 * @see net.sf.jame.mandelbrot.extensions.fractal.outcolouring.AbstractOutcolouringPaletteConfigNodeBuilderRuntime#createNodes(net.sf.jame.core.tree.Node, net.sf.jame.mandelbrot.extensions.fractal.outcolouring.AbstractOutcolouringPaletteConfig)
	 */
	@Override
