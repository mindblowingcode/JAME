...
import net.sf.jame.mandelbrot.extensions.paletteRendererFormula.COSRuntime;

/**
 * @author Andrea Medeghini
 */
public class COSDescriptor extends PaletteRendererFormulaExtensionDescriptor {
	/**
	...
	public String getExtensionId() {
		return "twister.mandelbrot.palette.renderer.formula.cos";
	}
