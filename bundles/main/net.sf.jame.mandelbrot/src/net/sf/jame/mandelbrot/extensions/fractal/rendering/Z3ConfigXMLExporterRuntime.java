 ...
 */
public class Z3ConfigXMLExporterRuntime extends ExtensionConfigXMLExporterExtensionRuntime {
	/**
	 * @see net.sf.jame.core.xml.extension.ExtensionConfigXMLExporterExtensionRuntime#createXMLExporter()
	 */
	@Override
	public XMLExporter<Z3Config> createXMLExporter() {
		return new Z3ConfigXMLExporter();
	}

	private class Z3ConfigXMLExporter extends AbstractRenderingFormulaConfigXMLExporter<Z3Config> {
		/**
