...
public abstract class AbstractOutcolouringFormulaRuntime<T extends OutcolouringFormulaExtensionConfig> extends OutcolouringFormulaExtensionRuntime<T> {
	/**
	 * @see net.sf.jame.mandelbrot.fractal.outcolouring.extension.OutcolouringFormulaExtensionRuntime#isHorizontalSymetryAllowed()
	 */
	@Override
	...
	/**
	 * @see net.sf.jame.mandelbrot.fractal.outcolouring.extension.OutcolouringFormulaExtensionRuntime#isVerticalSymetryAllowed()
	 */
	@Override
	...
	/**
	 * @see net.sf.jame.mandelbrot.fractal.outcolouring.extension.OutcolouringFormulaExtensionRuntime#isSolidGuessAllowed()
	 */
	@Override
