...
import net.sf.jame.mandelbrot.color.ColorRendererRuntimeElement;
...
public class UniversalRuntime extends AbstractIncolouringPaletteRuntime<UniversalConfig> {
	...
	/**
	 * @see net.sf.jame.mandelbrot.extensions.fractal.outcolouring.AbstractOutcolouringPaletteRuntime#prepareForRendering(int)
	 */
	@Override
	...
	/**
	 * @see net.sf.jame.mandelbrot.extensions.fractal.incolouring.AbstractIncolouringPaletteRuntime#renderIndex(net.sf.jame.mandelbrot.renderer.RenderedPoint)
	 */
	@Override
	...
	/**
	 * @see net.sf.jame.mandelbrot.extensions.fractal.incolouring.AbstractIncolouringPaletteRuntime#configReloaded()
	 */
	@Override
