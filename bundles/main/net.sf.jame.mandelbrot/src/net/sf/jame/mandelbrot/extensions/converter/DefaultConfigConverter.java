...
import net.sf.jame.twister.converter.ConfigConverter;
...
public class DefaultConfigConverter implements ConfigConverter {
	/**
	 * @see net.sf.jame.twister.converter.extension.ConverterExtensionRuntime#convert(java.io.File)
	 */
	...
	private static void buildXML(final StringBuffer buffer, final String plane, final String fractal, final String formula, final String wx, final String wy, final String cx, final String cy, final String scale, final String iterations) {
		...
		buffer.append("<palette class=\"it.topix.jame.plaf.Palette\" version=\"1.0\">");
		buffer.append("<sequence class=\"it.topix.jame.plaf.Sequence\" version=\"1.0\">");
		buffer.append("<function class=\"it.topix.jame.ColorTableFunction$LIN\"><configuration class=\"it.topix.jame.ColorTableFunction$LIN$FunctionConfiguration\" version=\"1.0\"/></function>");
	...
	private static final class FractalData {
		...
		private void load(final Reader r) throws IOException, FormatException {
			try {
				...
				if (!(id.equals("jame fractal 3.1"))) {
					if (!(id.equals("jame fractal 3.0"))) {
						if (!(id.equals("jame fractal 2.0"))) {
							if (!(id.equals("jame fractal 1.2"))) {
								...
								iterations = 400;
								if (formulamodule.equals("org.jame.engine.basic.module.fractal.fractalZ2")) {
									formulamodule = "org.jame.engine.basic.module.formula.formulaZ2";
								}
								else if (formulamodule.equals("org.jame.engine.basic.module.fractal.fractalZ3")) {
									formulamodule = "org.jame.engine.basic.module.formula.formulaZ3";
								}
								else if (formulamodule.equals("org.jame.engine.basic.module.fractal.fractalZ4")) {
									formulamodule = "org.jame.engine.basic.module.formula.formulaZ4";
								}
								else if (formulamodule.equals("org.jame.engine.basic.module.fractal.fractalZ5")) {
									formulamodule = "org.jame.engine.basic.module.formula.formulaZ5";
								}
								else if (formulamodule.equals("org.jame.engine.basic.module.fractal.fractalcosZ")) {
									formulamodule = "org.jame.engine.basic.module.formula.formulacosZ";
								}
								else if (formulamodule.equals("org.jame.engine.basic.module.fractal.fractalsinZ")) {
									formulamodule = "org.jame.engine.basic.module.formula.formulasinZ";
								}
								else if (formulamodule.equals("org.jame.engine.basic.module.fractal.fractalexpZ")) {
									formulamodule = "org.jame.engine.basic.module.formula.formulaexpZ";
								}
							}
						}
						else {
	...
	private class Converter4 {
		public TwisterConfig convert(final File file) {
			try {
				...
				String plane = "Lambda";
				String formula = null;
				if (data.getFormulaModule().indexOf("org.jame.engine.basic.module.formula.formula") > -1) {
					formula = data.getFormulaModule().substring("org.jame.engine.basic.module.formula.formula".length()).toUpperCase();
				}
				else {
