 ...
 */
public class TIFFEncoderRuntime extends FreeImageEncoderRuntime<TIFFEncoderConfig> {
	/**
	 * @see net.sf.jame.service.extensions.encoder.FreeImageEncoderRuntime#getFormat()
	 */
	@Override
