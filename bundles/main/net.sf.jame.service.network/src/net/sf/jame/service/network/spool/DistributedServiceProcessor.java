 ...
 *
 */
package net.sf.jame.service.network.spool;
...
import net.sf.jame.service.network.EventMessage;
import net.sf.jame.service.network.RequestMessage;
import net.sf.jame.service.network.ResponseMessage;
...
import net.sf.jame.service.spool.DistributedJobService;
...
import net.sf.jame.service.spool.job.DistributedJobDecoder;
...
public class DistributedServiceProcessor implements ServiceProcessor {
	...
	/**
	 * @see net.sf.jame.service.network.ServiceProcessor#start()
	 */
	public void start() {
		jobService.start();
		if (thread == null) {
	...
	/**
	 * @see net.sf.jame.service.network.ServiceProcessor#stop()
	 */
	public void stop() {
		jobService.stop();
		if (thread != null) {
	...
	/**
	 * @see net.sf.jame.service.network.ServiceProcessor#createSessionHandler()
	 */
	...
	private class SpoolSessionHandler implements SessionHandler {
		...
		/**
		 * @see net.sf.jame.service.network.SessionHandler#dispose()
		 */
		public void dispose() {
			if (session != null) {
				session.dispose();
		...
		/**
		 * @see net.sf.jame.service.network.SessionHandler#setSession(net.sf.jame.service.network.ServiceSession)
		 */
		...
		/**
		 * @see net.sf.jame.service.network.SessionHandler#getSession()
		 */
		...
		/**
		 * @see net.sf.jame.service.network.SessionHandler#isExpired()
		 */
		...
		/**
		 * @see net.sf.jame.service.network.SessionHandler#onMessage(net.sf.jame.service.network.ServiceMessage)
		 */
	...
	private class SpoolJobListener implements JobListener {
		...
		/**
		 * @see net.sf.jame.service.spool.JobListener#stateChanged(String, JobData)
		 */
