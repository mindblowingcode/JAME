		...
		try {
			...
			try {
				...
				if ((properties.get("workspace") == null) || (System.getProperty("jame.workspace") != null)) {
					workspace = new File(System.getProperty("jame.workspace", System.getProperty("user.home") + "/JXTARendezvous-workspace").replace("${user.home}", System.getProperty("user.home")));
			...
			if (workspace != null) {
				Configurator.configure(workspace.getAbsoluteFile(), "JXTARendezvous.log");
