...
public class ColorConfigXMLImporterRuntime extends ExtensionConfigXMLImporterExtensionRuntime {
	...
	private class ColorConfigXMLImporter extends AbstractImageConfigXMLImporter<ColorConfig> {
		/**
		 * @see net.sf.jame.twister.extensions.frame.layer.image.AbstractImageConfigXMLImporter#createExtensionConfig()
		 */
		@Override
		...
		/**
		 * @see net.sf.jame.twister.extensions.frame.layer.image.AbstractImageConfigXMLImporter#getConfigElementClassId()
		 */
		@Override
		...
		/**
		 * @see net.sf.jame.twister.extensions.frame.layer.image.AbstractImageConfigXMLImporter#importFromElement(org.w3c.dom.Element)
		 */
		@Override
