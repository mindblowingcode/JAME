...
public class ColorRuntime extends FrameFilterExtensionRuntime<ColorConfig> {
	...
	/**
	 * @see net.sf.jame.twister.frame.filter.extension.FrameFilterExtensionRuntime#renderImage(net.sf.jame.core.util.Surface, net.sf.jame.core.util.Surface, net.sf.jame.core.util.Surface)
	 */
	@Override
