 ...
 */
public class ImageConfigElementNodeValue extends NodeValue<ImageConfigElement> {
	private static final long serialVersionUID = 1L;

	/**
	 * @param value
	 */
	public ImageConfigElementNodeValue(final ImageConfigElement value) {
		super(value);
	}
	...
	public ImageConfigElementNodeValue clone() {
		return new ImageConfigElementNodeValue(getValueClone());
	}
}
