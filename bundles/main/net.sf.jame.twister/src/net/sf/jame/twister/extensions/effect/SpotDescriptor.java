...
import net.sf.jame.twister.extensions.effect.SpotRuntime;
import net.sf.jame.twister.extensions.effect.SpotConfig;

/**
 * @author Andrea Medeghini
 */
public class SpotDescriptor extends EffectExtensionDescriptor {
	/**
	 ...
	 */
	public SpotRuntime getExtensionRuntime() {
		return new SpotRuntime();
	}
	 ...
	 */
	public SpotConfig getExtensionConfig() {
