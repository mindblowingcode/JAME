...
public class GroupLayerConfigElementXMLImporter extends AbstractLayerConfigElementXMLImporter<GroupLayerConfigElement> {
	...
	/**
	 * @see net.sf.jame.twister.frame.layer.AbstractLayerConfigElementXMLImporter#importProperties(net.sf.jame.twister.frame.layer.LayerConfigElement, java.util.List)
	 */
	@Override
