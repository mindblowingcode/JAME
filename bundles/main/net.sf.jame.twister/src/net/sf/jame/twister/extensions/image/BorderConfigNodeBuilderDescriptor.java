 ...
 */
public class BorderConfigNodeBuilderDescriptor extends NodeBuilderExtensionDescriptor {
	/**
	 ...
	 */
	public BorderConfigNodeBuilderRuntime getExtensionRuntime() {
		return new BorderConfigNodeBuilderRuntime();
	}
}
