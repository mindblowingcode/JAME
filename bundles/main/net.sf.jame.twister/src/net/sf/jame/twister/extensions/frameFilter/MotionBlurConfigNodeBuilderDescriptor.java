 ...
 */
public class MotionBlurConfigNodeBuilderDescriptor extends NodeBuilderExtensionDescriptor {
	/**
	 ...
	 */
	public MotionBlurConfigNodeBuilderRuntime getExtensionRuntime() {
		return new MotionBlurConfigNodeBuilderRuntime();
	}
}
