...
import net.sf.jame.twister.extensions.layerFilter.BlackRuntime;
import net.sf.jame.twister.extensions.layerFilter.BlackConfig;

/**
 * @author Andrea Medeghini
 */
public class BlackDescriptor extends LayerFilterExtensionDescriptor {
	/**
	 ...
	 */
	public BlackRuntime getExtensionRuntime() {
		return new BlackRuntime();
	}
	 ...
	 */
	public BlackConfig getExtensionConfig() {
