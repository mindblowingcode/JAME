...
import net.sf.jame.twister.frame.layer.filter.LayerFilterConfigElementXMLExporter;
import net.sf.jame.twister.frame.layer.image.ImageConfigElementXMLExporter;
...
public class ImageLayerConfigElementXMLExporter extends AbstractLayerConfigElementXMLExporter<ImageLayerConfigElement> {
	/**
	 * @see net.sf.jame.twister.frame.layer.AbstractLayerConfigElementXMLExporter#exportProperties(net.sf.jame.twister.frame.layer.LayerConfigElement, org.w3c.dom.Element, net.sf.jame.core.xml.XMLNodeBuilder)
	 */
	@Override
