...
import net.sf.jame.twister.extensions.effect.FireRuntime;
import net.sf.jame.twister.extensions.effect.FireConfig;

/**
 * @author Andrea Medeghini
 */
public class FireDescriptor extends EffectExtensionDescriptor {
	/**
	 ...
	 */
	public FireRuntime getExtensionRuntime() {
		return new FireRuntime();
	}
	 ...
	 */
	public FireConfig getExtensionConfig() {
