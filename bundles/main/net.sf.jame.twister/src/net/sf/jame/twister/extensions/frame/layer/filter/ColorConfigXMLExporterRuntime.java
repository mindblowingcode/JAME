...
public class ColorConfigXMLExporterRuntime extends ExtensionConfigXMLExporterExtensionRuntime {
	...
	private class ColorConfigXMLExporter extends AbstractLayerFilterConfigXMLExporter<ColorConfig> {
		...
		/**
		 * @see net.sf.jame.twister.extensions.frame.layer.filter.AbstractLayerFilterConfigXMLExporter#exportToElement(net.sf.jame.twister.frame.layer.filter.extension.LayerFilterExtensionConfig, net.sf.jame.core.xml.XMLNodeBuilder)
		 */
		@Override
