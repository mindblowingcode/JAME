...
public class MotionBlurConfigXMLExporterRuntime extends ExtensionConfigXMLExporterExtensionRuntime {
	...
	private class MotionBlurConfigXMLExporter extends AbstractFrameFilterConfigXMLExporter<MotionBlurConfig> {
		...
		/**
		 * @see net.sf.jame.twister.extensions.frame.filter.AbstractFrameFilterConfigXMLExporter#exportToElement(net.sf.jame.twister.frame.filter.extension.FrameFilterExtensionConfig, net.sf.jame.core.xml.XMLNodeBuilder)
		 */
		@Override
