...
public class MotionBlurConfigXMLImporterRuntime extends ExtensionConfigXMLImporterExtensionRuntime {
	...
	private class MotionBlurConfigXMLImporter extends AbstractFrameFilterConfigXMLImporter<MotionBlurConfig> {
		/**
		 * @see net.sf.jame.twister.extensions.frame.filter.AbstractFrameFilterConfigXMLImporter#createExtensionConfig()
		 */
		@Override
		...
		/**
		 * @see net.sf.jame.twister.extensions.frame.filter.AbstractFrameFilterConfigXMLImporter#getConfigElementClassId()
		 */
		@Override
		...
		/**
		 * @see net.sf.jame.twister.extensions.frame.filter.AbstractFrameFilterConfigXMLImporter#importFromElement(org.w3c.dom.Element)
		 */
		@Override
