 ...
 */
public class BlurConfigXMLExporterDescriptor extends ExtensionConfigXMLExporterExtensionDescriptor {
	/**
	 ...
	 */
	public BlurConfigXMLExporterRuntime getExtensionRuntime() {
		return new BlurConfigXMLExporterRuntime();
	}
}
