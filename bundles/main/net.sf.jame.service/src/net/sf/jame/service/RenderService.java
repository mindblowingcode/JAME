...
import net.sf.jame.service.spool.job.CopyProcessSpoolJob;
import net.sf.jame.service.spool.job.CopyProcessSpoolJobFactory;
import net.sf.jame.service.spool.job.PostProcessSpoolJob;
import net.sf.jame.service.spool.job.PostProcessSpoolJobFactory;
...
public class RenderService {
	...
	private class DefaultClipPreview implements ClipPreview {
		...
		/**
		 * @see net.sf.jame.service.clip.ClipPreview#getImage()
		 */
		...
		/**
		 * @see net.sf.jame.service.clip.ClipPreview#dispose()
		 */
		public void dispose() {
			if (surface != null) {
				surface.dispose();
		...
		/**
		 * @see net.sf.jame.service.clip.ClipPreview#update()
		 */
		public void update() {
			render(clipId);
		}
