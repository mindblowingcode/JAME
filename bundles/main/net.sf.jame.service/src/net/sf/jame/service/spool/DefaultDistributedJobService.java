...
public class DefaultDistributedJobService<T extends DistributedJobInterface> extends DefaultJobService<T> implements DistributedJobService<T> {
	...
	/**
	 * @see net.sf.jame.service.spool.DistributedJobService#setJobFrame(java.lang.String, net.sf.jame.twister.TwisterClip, byte[])
	 */
	...
	/**
	 * @see net.sf.jame.service.spool.DistributedJobService#getJobFrame(java.lang.String, int)
	 */
