...
public class FillRuleDescriptorRuntime extends DescriptorExtensionRuntime {
	/**
	...
	public ProcessorDescriptor createDescriptor(String elementName, String defaultValue, ProcessorCardinality cardinality) {
		return new ProcessorDescriptor(elementName, "FillRule", FillRuleElement.CLASS_ID, "net.sf.jame.contextfree.common", "FillRuleElement", null, null, null, null, null, null, null, null, null, null, null, null, "java.lang", "String", defaultValue, "get", "set", cardinality);
	}
	...
	public String getClassId() {
		return FillRuleElement.CLASS_ID;
	}
}
