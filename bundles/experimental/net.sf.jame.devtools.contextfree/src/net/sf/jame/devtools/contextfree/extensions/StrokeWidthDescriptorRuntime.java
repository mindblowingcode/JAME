 ...
 *
 */
package net.sf.jame.devtools.contextfree.extensions;
...
public class StrokeWidthDescriptorRuntime extends DescriptorExtensionRuntime {
	/**
	...
	public ProcessorDescriptor createDescriptor(String elementName, String defaultValue, ProcessorCardinality cardinality) {
		return new ProcessorDescriptor(elementName, "StrokeWidth", StrokeWidthElement.CLASS_ID, "net.sf.jame.contextfree.common", "StrokeWidthElement", null, null, null, null, null, null, null, null, null, null, null, null, "java.lang", "Float", defaultValue, "get", "set", cardinality);
	}
	...
	public String getClassId() {
		return StrokeWidthElement.CLASS_ID;
	}
}
