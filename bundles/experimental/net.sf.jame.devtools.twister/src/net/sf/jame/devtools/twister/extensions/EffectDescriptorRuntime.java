 ...
 *
 */
package net.sf.jame.devtools.twister.extensions;
...
public class EffectDescriptorRuntime extends DescriptorExtensionRuntime {
	/**
	...
	public ProcessorDescriptor createDescriptor(String elementName, String defaultValue, ProcessorCardinality cardinality) {
		return new ProcessorDescriptor(elementName, "Effect", EffectConfigElement.CLASS_ID, "net.sf.jame.twister.effect", "EffectConfigElement", "net.sf.jame.twister.effect", "EffectRuntimeElement", null, null, null, null, null, null, null, null, "", "", null, null, null, "get", "set", cardinality);
	}
	...
	public String getClassId() {
		return EffectConfigElement.CLASS_ID;
	}
}
