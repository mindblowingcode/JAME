...
public class ExtensionRegistryProcessorRuntime extends ProcessorExtensionRuntime {
	...
	private void prepare(Set<String> imports, ProcessorDescriptor descriptor) {
		if (descriptor.isExtension()) {
			imports.add("net.sf.jame.core.extension.osgi.OSGiExtensionBuilder");
			imports.add("net.sf.jame.core.extension.osgi.OSGiExtensionRegistry");
		}
		else if (descriptor.isConfigurableExtension()) {
			imports.add("net.sf.jame.core.extension.osgi.OSGiConfigurableExtensionBuilder");
			imports.add("net.sf.jame.core.extension.osgi.OSGiConfigurableExtensionRegistry");
		}
	}
}
