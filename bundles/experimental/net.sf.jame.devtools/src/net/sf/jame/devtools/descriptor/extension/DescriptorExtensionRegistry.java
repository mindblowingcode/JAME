 ...
 */
public class DescriptorExtensionRegistry extends OSGiExtensionRegistry<DescriptorExtensionRuntime> {
	/**
	...
	public DescriptorExtensionRegistry() {
		super(DescriptorExtensionRegistry.EXTENSION_POINT_NAME, new OSGiExtensionBuilder<DescriptorExtensionRuntime>(DescriptorExtensionRegistry.CONFIGURATION_ELEMENT_NAME));
	}
}
