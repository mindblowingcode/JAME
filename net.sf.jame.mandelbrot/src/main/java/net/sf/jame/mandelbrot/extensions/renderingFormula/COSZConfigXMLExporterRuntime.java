 ...
 */
public class COSZConfigXMLExporterRuntime extends ExtensionConfigXMLExporterExtensionRuntime {
	/**
	 * @see net.sf.jame.core.extensionConfigXMLExporter.extension.ExtensionConfigXMLExporterExtensionRuntime#createXMLExporter()
	 */
	@Override
	public XMLExporter<COSZConfig> createXMLExporter() {
		return new COSZConfigXMLExporter();
	}

	private class COSZConfigXMLExporter extends AbstractRenderingFormulaConfigXMLExporter<COSZConfig> {
		/**
