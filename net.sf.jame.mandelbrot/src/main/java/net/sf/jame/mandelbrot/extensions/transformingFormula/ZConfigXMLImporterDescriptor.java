...
import net.sf.jame.mandelbrot.extensions.transformingFormula.ZConfigXMLImporterRuntime;

/**
 * @author Andrea Medeghini
 */
public class ZConfigXMLImporterDescriptor extends ExtensionConfigXMLImporterExtensionDescriptor {
	/**
