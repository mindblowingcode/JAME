...
import net.sf.jame.mandelbrot.extensions.incolouringFormula.AbstractIncolouringFormulaRuntime;
...
public class BinaryRuntime extends AbstractIncolouringFormulaRuntime<BinaryConfig> {
	...
	/**
	 * @see net.sf.jame.mandelbrot.extensions.incolouringFormula.AbstractIncolouringFormulaRuntime#prepareForRendering(int)
	 */
	@Override
