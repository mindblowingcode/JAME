 ...
 */
public class IncolouringFormulaCreatorRuntime extends CreatorExtensionRuntime {
	/**
	...
	public Object create(final Object... args) throws JSException {
		if ((args != null) && (args.length > 0)) {
			throw new JSException("IncolouringFormulaConfigElement creator requires no arguments");
		}
