 ...
 */
public class COSZDescriptor extends RenderingFormulaExtensionDescriptor {
	/**
	 ...
	 */
	public COSZRuntime getExtensionRuntime() {
		return new COSZRuntime();
	}
	 ...
	 */
	public COSZConfig getExtensionConfig() {
