 ...
 */
public class PaletteRendererFormulaCreatorRuntime extends CreatorExtensionRuntime {
	/**
	...
	public Object create(final Object... args) throws JSException {
		if ((args != null) && (args.length > 0)) {
			throw new JSException("PaletteRendererFormulaConfigElement creator requires no arguments");
		}
		return new PaletteRendererFormulaConfigElement();
	}
}
