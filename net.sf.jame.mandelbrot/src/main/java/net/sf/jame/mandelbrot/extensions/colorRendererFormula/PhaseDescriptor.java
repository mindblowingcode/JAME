...
import net.sf.jame.mandelbrot.extensions.colorRendererFormula.PhaseRuntime;

/**
 * @author Andrea Medeghini
 */
public class PhaseDescriptor extends ColorRendererFormulaExtensionDescriptor {
	/**
	...
	public String getExtensionId() {
		return "twister.mandelbrot.color.renderer.formula.phase";
	}
