 ...
 */
public class LINDescriptor extends PaletteRendererFormulaExtensionDescriptor {
	/**
	...
	public String getExtensionId() {
		return "twister.mandelbrot.palette.renderer.formula.lin";
	}
	 ...
	 */
	public LINRuntime getExtensionRuntime() {
		return new LINRuntime();
	}
}
