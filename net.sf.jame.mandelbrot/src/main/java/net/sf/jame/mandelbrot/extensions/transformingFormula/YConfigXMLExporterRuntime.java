 ...
 */
public class YConfigXMLExporterRuntime extends ExtensionConfigXMLExporterExtensionRuntime {
	/**
	 * @see net.sf.jame.core.extensionConfigXMLExporter.extension.ExtensionConfigXMLExporterExtensionRuntime#createXMLExporter()
	 */
	@Override
	public XMLExporter<YConfig> createXMLExporter() {
		return new YConfigXMLExporter();
	}

	private class YConfigXMLExporter extends AbstractTransformingFormulaConfigXMLExporter<YConfig> {
		/**
		 ...
		 */
		@Override
		protected void exportProperties(final YConfig config, final Element element, final XMLNodeBuilder builder) throws XMLExportException {
		}
	}
}
