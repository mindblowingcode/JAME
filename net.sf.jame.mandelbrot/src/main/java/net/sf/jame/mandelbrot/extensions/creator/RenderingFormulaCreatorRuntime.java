 ...
 */
public class RenderingFormulaCreatorRuntime extends CreatorExtensionRuntime {
	/**
	...
	public Object create(final Object... args) throws JSException {
		if ((args != null) && (args.length > 0)) {
			throw new JSException("RenderingFormulaConfigElement creator requires no arguments");
		}
		return new RenderingFormulaConfigElement();
	}
}
