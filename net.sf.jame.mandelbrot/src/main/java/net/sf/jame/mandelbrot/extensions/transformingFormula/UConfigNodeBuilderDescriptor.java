 ...
 */
public class UConfigNodeBuilderDescriptor extends NodeBuilderExtensionDescriptor {
	/**
	 ...
	 */
	public UConfigNodeBuilderRuntime getExtensionRuntime() {
		return new UConfigNodeBuilderRuntime();
	}
}
