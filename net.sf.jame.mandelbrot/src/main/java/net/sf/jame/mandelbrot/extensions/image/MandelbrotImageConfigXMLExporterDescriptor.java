 ...
 */
public class MandelbrotImageConfigXMLExporterDescriptor extends ExtensionConfigXMLExporterExtensionDescriptor {
	/**
	 ...
	 */
	public MandelbrotImageConfigXMLExporterRuntime getExtensionRuntime() {
		return new MandelbrotImageConfigXMLExporterRuntime();
	}
}
