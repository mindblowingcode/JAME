 ...
 */
public class ProcessingFormulaEnumeratorRuntime extends EnumeratorExtensionRuntime {
	/**
	...
	public List<String> listExtensions() throws JSException {
		List<Extension<ProcessingFormulaExtensionRuntime>> extensions = MandelbrotRegistry.getInstance().getProcessingFormulaRegistry().getExtensionList();
		List<String> references = new LinkedList<String>();
		for (Extension<ProcessingFormulaExtensionRuntime> extension : extensions) {
