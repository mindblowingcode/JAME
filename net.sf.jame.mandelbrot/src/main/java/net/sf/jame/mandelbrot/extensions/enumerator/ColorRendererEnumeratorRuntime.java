 ...
 */
public class ColorRendererEnumeratorRuntime extends EnumeratorExtensionRuntime {
	/**
	...
	public List<String> listExtensions() throws JSException {
		List<Extension<ColorRendererExtensionRuntime<?>>> extensions = MandelbrotRegistry.getInstance().getColorRendererRegistry().getExtensionList();
		List<String> references = new LinkedList<String>();
		for (Extension<ColorRendererExtensionRuntime<?>> extension : extensions) {
	...
	public JSExtension getExtension(final String extensionId) throws JSException {
		try {
			return new JSExtension(MandelbrotRegistry.getInstance().getColorRendererExtension(extensionId));
		}
