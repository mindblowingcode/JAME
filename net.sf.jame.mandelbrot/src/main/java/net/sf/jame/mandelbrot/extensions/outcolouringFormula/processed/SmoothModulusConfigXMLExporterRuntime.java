 ...
 */
public class SmoothModulusConfigXMLExporterRuntime extends ExtensionConfigXMLExporterExtensionRuntime {
	/**
	 * @see net.sf.jame.core.extensionConfigXMLExporter.extension.ExtensionConfigXMLExporterExtensionRuntime#createXMLExporter()
	 */
	@Override
	public XMLExporter<SmoothModulusConfig> createXMLExporter() {
		return new SmoothModulusConfigXMLExporter();
	}

	private class SmoothModulusConfigXMLExporter extends AbstractOutcolouringPaletteConfigXMLExporter<SmoothModulusConfig> {
		/**
