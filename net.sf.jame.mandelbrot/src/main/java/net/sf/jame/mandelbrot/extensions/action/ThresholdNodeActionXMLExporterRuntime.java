 ...
 */
public class ThresholdNodeActionXMLExporterRuntime extends AbstractActionXMLExporterRuntime {
	/**
	...
	protected void exportParams(final NodeActionValue action, final Element element, final XMLNodeBuilder builder) throws XMLExportException {
		final ThresholdElementXMLExporter exporter = new ThresholdElementXMLExporter();
		final ThresholdElement configElement0 = new ThresholdElement((Double) action.getActionParams()[0]);
		final ThresholdElement configElement1 = new ThresholdElement((Double) action.getActionParams()[1]);
