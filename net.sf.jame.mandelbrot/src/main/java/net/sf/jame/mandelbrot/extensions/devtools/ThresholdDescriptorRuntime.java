...
public class ThresholdDescriptorRuntime extends DescriptorExtensionRuntime {
	...
	public ProcessorDescriptor createDescriptor(String elementName, String defaultValue, ProcessorCardinality cardinality) {
		return new ProcessorDescriptor(elementName, "Threshold", ThresholdElement.CLASS_ID, "net.sf.jame.mandelbrot.common", "ThresholdElement", null, null, null, null, null, null, null, null, null, null, null, null, "java.lang", "Double", defaultValue, "get", "set", cardinality);
	}
	...
	public String getClassId() {
		return ThresholdElement.CLASS_ID;
	}
}
