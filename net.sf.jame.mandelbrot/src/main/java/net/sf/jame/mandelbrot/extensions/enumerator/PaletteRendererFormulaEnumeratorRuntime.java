 ...
 */
public class PaletteRendererFormulaEnumeratorRuntime extends EnumeratorExtensionRuntime {
	/**
	...
	public List<String> listExtensions() throws JSException {
		List<Extension<PaletteRendererFormulaExtensionRuntime>> extensions = MandelbrotRegistry.getInstance().getPaletteRendererFormulaRegistry().getExtensionList();
		List<String> references = new LinkedList<String>();
		for (Extension<PaletteRendererFormulaExtensionRuntime> extension : extensions) {
	...
	public JSExtension getExtension(final String extensionId) throws JSException {
		try {
			return new JSExtension(MandelbrotRegistry.getInstance().getPaletteRendererFormulaExtension(extensionId));
		}
