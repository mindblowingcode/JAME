 ...
 */
public class IntegerElementEditorRuntime extends EditorExtensionRuntime {
	/**
	...
	private class EditorComponent extends JPanel implements NodeEditorComponent {
		...
		public EditorComponent(final NodeEditor nodeEditor) {
			...
			final Integer value = ((IntegerElementNodeValue) nodeEditor.getNodeValue()).getValue();
		...
		private class FieldListener implements ActionListener, FocusListener {
			...
			public void actionPerformed(final ActionEvent e) {
				Integer value = ((IntegerElementNodeValue) nodeEditor.getNodeValue()).getValue();
				try {
				...
				if (!nodeEditor.getNodeValue().getValue().equals(value)) {
					nodeEditor.setNodeValue(new IntegerElementNodeValue(value));
				}
			}
