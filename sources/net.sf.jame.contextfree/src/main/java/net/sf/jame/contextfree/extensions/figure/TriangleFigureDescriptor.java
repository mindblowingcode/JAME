 ...
 */
public class TriangleFigureDescriptor extends FigureExtensionDescriptor {
	/**
	 ...
	 */
	public TriangleFigureRuntime getExtensionRuntime() {
		return new TriangleFigureRuntime();
	}
	 ...
	 */
	public TriangleFigureConfig getExtensionConfig() {
