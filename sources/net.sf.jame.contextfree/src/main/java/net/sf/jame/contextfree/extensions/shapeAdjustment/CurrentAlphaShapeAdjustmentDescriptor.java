...
import net.sf.jame.contextfree.extensions.shapeAdjustment.CurrentAlphaShapeAdjustmentRuntime;
import net.sf.jame.contextfree.extensions.shapeAdjustment.CurrentAlphaShapeAdjustmentConfig;

/**
 * @author Andrea Medeghini
 */
public class CurrentAlphaShapeAdjustmentDescriptor extends ShapeAdjustmentExtensionDescriptor {
	/**
	 ...
	 */
	public CurrentAlphaShapeAdjustmentRuntime getExtensionRuntime() {
		return new CurrentAlphaShapeAdjustmentRuntime();
	}
	 ...
	 */
	public CurrentAlphaShapeAdjustmentConfig getExtensionConfig() {
