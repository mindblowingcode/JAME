...
import net.sf.jame.contextfree.extensions.pathAdjustment.RotatePathAdjustmentConfigXMLExporterRuntime;

/**
 * @author Andrea Medeghini
 */
public class RotatePathAdjustmentConfigXMLExporterDescriptor extends ExtensionConfigXMLExporterExtensionDescriptor {
	/**
