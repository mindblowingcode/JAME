...
zip -j net.sf.freeimage4java.native-0.1.1-linux_x86.jar dist/net.sf.freeimage4java/linux/x86/libfreeimage4java.so 
zip -j net.sf.freeimage4java.native-0.1.1-linux_x86_64.jar dist/net.sf.freeimage4java/linux/x86_64/libfreeimage4java.so 

zip -j net.sf.freeimage4java.native-0.1.1-win32_x86.jar dist/net.sf.freeimage4java/win32/x86/freeimage4java.dll 
zip -j net.sf.freeimage4java.native-0.1.1-win32_x86_64.jar dist/net.sf.freeimage4java/win32/x86_64/freeimage4java.dll 

zip -j net.sf.freeimage4java.native-0.1.1-osx_x86.jar dist/net.sf.freeimage4java/osx/x86/libfreeimage4java.jnilib 
zip -j net.sf.freeimage4java.native-0.1.1-osx_x86_64.jar dist/net.sf.freeimage4java/osx/x86_64/libfreeimage4java.jnilib 

zip -j net.sf.ffmpeg4java.native-0.1.2-linux_x86.jar dist/net.sf.ffmpeg4java/linux/x86/libffmpeg4java.so 
zip -j net.sf.ffmpeg4java.native-0.1.2-linux_x86_64.jar dist/net.sf.ffmpeg4java/linux/x86_64/libffmpeg4java.so 

zip -j net.sf.ffmpeg4java.native-0.1.2-win32_x86.jar dist/net.sf.ffmpeg4java/win32/x86/ffmpeg4java.dll 
zip -j net.sf.ffmpeg4java.native-0.1.2-win32_x86_64.jar dist/net.sf.ffmpeg4java/win32/x86_64/ffmpeg4java.dll

zip -j net.sf.ffmpeg4java.native-0.1.2-osx_x86.jar dist/net.sf.ffmpeg4java/osx/x86/libffmpeg4java.jnilib 
zip -j net.sf.ffmpeg4java.native-0.1.2-osx_x86_64.jar dist/net.sf.ffmpeg4java/osx/x86_64/libffmpeg4java.jnilib 
...
mvn install:install-file -Dpackaging=jar -DgroupId=net.sf.freeimage4java -Dversion=0.1.1 \
	-DartifactId=net.sf.freeimage4java -Dfile=dist/net.sf.freeimage4java/freeimage4java.jar

mvn install:install-file -Dpackaging=jar -DgroupId=net.sf.ffmpeg4java -Dversion=0.1.2 \
	-DartifactId=net.sf.ffmpeg4java -Dfile=dist/net.sf.ffmpeg4java/ffmpeg4java.jar
