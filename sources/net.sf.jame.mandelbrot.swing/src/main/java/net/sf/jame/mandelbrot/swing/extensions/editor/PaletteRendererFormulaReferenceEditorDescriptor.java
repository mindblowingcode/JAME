...
import net.sf.jame.mandelbrot.swing.extensions.editor.PaletteRendererFormulaReferenceEditorRuntime;

/**
 * @author Andrea Medeghini
 */
public class PaletteRendererFormulaReferenceEditorDescriptor extends EditorExtensionDescriptor {
	/**
