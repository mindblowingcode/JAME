...
public class SpeedDescriptorRuntime extends DescriptorExtensionRuntime {
	...
	public ProcessorDescriptor createDescriptor(String elementName, String defaultValue, ProcessorCardinality cardinality) {
		return new ProcessorDescriptor(elementName, "Speed", SpeedElement.CLASS_ID, "net.sf.jame.twister.common", "SpeedElement", null, null, null, null, null, null, null, null, null, null, null, null, "net.sf.jame.twister.util", "Speed", defaultValue, "get", "set", cardinality);
	}
