...
public class FloatDescriptorRuntime extends DescriptorExtensionRuntime {
	/**
	...
	public ProcessorDescriptor createDescriptor(String elementName, String defaultValue, ProcessorCardinality cardinality) {
		return new ProcessorDescriptor(elementName, "Float", FloatElement.CLASS_ID, "net.sf.jame.core.common", "FloatElement", null, null, null, null, null, null, null, null, null, null, null, null, "java.lang", "Float", defaultValue, "get", "set", cardinality);
	}
