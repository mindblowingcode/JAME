 ...
 */
public class IntegerElementXMLImporter extends ValueConfigElementXMLImporter<Integer, IntegerElement> {
	/**
	 ...
	 */
	@Override
	protected IntegerElement createDefaultConfigElement() {
