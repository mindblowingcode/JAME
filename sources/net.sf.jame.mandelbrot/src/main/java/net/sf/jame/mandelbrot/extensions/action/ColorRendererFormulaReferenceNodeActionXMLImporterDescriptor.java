...
import net.sf.jame.mandelbrot.extensions.action.ColorRendererFormulaReferenceNodeActionXMLImporterRuntime;

/**
 * @author Andrea Medeghini
 */
public class ColorRendererFormulaReferenceNodeActionXMLImporterDescriptor extends ActionXMLImporterExtensionDescriptor {
	/**
