 ...
 */
public class Z5ConfigXMLExporterRuntime extends ExtensionConfigXMLExporterExtensionRuntime {
	/**
	 * @see net.sf.jame.core.extensionConfigXMLExporter.extension.ExtensionConfigXMLExporterExtensionRuntime#createXMLExporter()
	 */
	@Override
	public XMLExporter<Z5Config> createXMLExporter() {
		return new Z5ConfigXMLExporter();
	}

	private class Z5ConfigXMLExporter extends AbstractRenderingFormulaConfigXMLExporter<Z5Config> {
		/**
