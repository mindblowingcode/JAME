...
import net.sf.jame.mandelbrot.extensions.creator.RenderedPaletteCreatorRuntime;

/**
 * @author Andrea Medeghini
 */
public class RenderedPaletteCreatorDescriptor extends CreatorExtensionDescriptor {
	/**
