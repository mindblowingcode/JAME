 ...
 */
public class SharpenConfigXMLExporterRuntime extends ExtensionConfigXMLExporterExtensionRuntime {
	/**
	 * @see net.sf.jame.core.extensionConfigXMLExporter.extension.ExtensionConfigXMLExporterExtensionRuntime#createXMLExporter()
	 */
	@Override
	public XMLExporter<SharpenConfig> createXMLExporter() {
		return new SharpenConfigXMLExporter();
	}

	private class SharpenConfigXMLExporter extends AbstractLayerFilterConfigXMLExporter<SharpenConfig> {
		/**
