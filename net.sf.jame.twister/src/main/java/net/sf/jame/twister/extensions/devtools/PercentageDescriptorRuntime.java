...
public class PercentageDescriptorRuntime extends DescriptorExtensionRuntime {
	...
	public ProcessorDescriptor createDescriptor(String elementName, String defaultValue, ProcessorCardinality cardinality) {
		return new ProcessorDescriptor(elementName, "Percentage", PercentageElement.CLASS_ID, "net.sf.jame.twister.common", "PercentageElement", null, null, null, null, null, null, null, null, null, null, null, null, "net.sf.jame.twister.util", "Percentage", defaultValue, "get", "set", cardinality);
	}
