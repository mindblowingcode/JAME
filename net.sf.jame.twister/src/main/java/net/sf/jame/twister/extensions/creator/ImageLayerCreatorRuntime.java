 ...
 */
public class ImageLayerCreatorRuntime extends CreatorExtensionRuntime {
	/**
	...
	public Object create(final Object... args) throws JSException {
		if ((args != null) && (args.length > 0)) {
			throw new JSException("ImageLayerConfigElement creator requires no arguments");
		}
		ImageLayerConfigElement configElement = new ImageLayerConfigElement();
		configElement.setImageConfigElement(new ImageConfigElement());
