...
public class ViewDescriptorRuntime extends DescriptorExtensionRuntime {
	...
	public ProcessorDescriptor createDescriptor(String elementName, String defaultValue, ProcessorCardinality cardinality) {
		return new ProcessorDescriptor(elementName, "View", ViewElement.CLASS_ID, "net.sf.jame.twister.common", "ViewElement", null, null, null, null, null, null, null, null, null, null, null, null, "net.sf.jame.twister.util", "View", defaultValue, "get", "set", cardinality);
	}
