 ...
 */
public class EdgeConfigXMLExporterRuntime extends ExtensionConfigXMLExporterExtensionRuntime {
	/**
	 * @see net.sf.jame.core.extensionConfigXMLExporter.extension.ExtensionConfigXMLExporterExtensionRuntime#createXMLExporter()
	 */
	@Override
	public XMLExporter<EdgeConfig> createXMLExporter() {
		return new EdgeConfigXMLExporter();
	}

	private class EdgeConfigXMLExporter extends AbstractLayerFilterConfigXMLExporter<EdgeConfig> {
		/**
