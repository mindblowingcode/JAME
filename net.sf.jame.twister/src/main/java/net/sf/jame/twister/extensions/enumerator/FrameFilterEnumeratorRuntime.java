 ...
 */
public class FrameFilterEnumeratorRuntime extends EnumeratorExtensionRuntime {
	/**
	...
	public List<String> listExtensions() throws JSException {
		List<Extension<FrameFilterExtensionRuntime<?>>> extensions = TwisterRegistry.getInstance().getFrameFilterRegistry().getExtensionList();
		List<String> references = new LinkedList<String>();
		for (Extension<FrameFilterExtensionRuntime<?>> extension : extensions) {
