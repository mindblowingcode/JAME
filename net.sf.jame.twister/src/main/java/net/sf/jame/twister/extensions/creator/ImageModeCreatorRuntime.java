 ...
 */
public class ImageModeCreatorRuntime extends CreatorExtensionRuntime {
	/**
	...
	public Object create(final Object... args) throws JSException {
		try {
			...
			throw new JSException("Image mode creator requires one arguments: #1 of type Number", e);
		}
	}
}
