 ...
 */
public class InputModeCreatorRuntime extends CreatorExtensionRuntime {
	/**
	...
	public Object create(final Object... args) throws JSException {
		try {
			return new Integer(toInteger(args[0]));
		}
		catch (Exception e) {
			throw new JSException("Input mode creator requires one arguments: #1 of type Number", e);
		}
	}
}
