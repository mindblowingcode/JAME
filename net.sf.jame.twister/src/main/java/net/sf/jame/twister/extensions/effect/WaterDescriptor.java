 ...
 */
public class WaterDescriptor extends EffectExtensionDescriptor {
	/**
	 ...
	 */
	public WaterRuntime getExtensionRuntime() {
		return new WaterRuntime();
	}
	 ...
	 */
	public WaterConfig getExtensionConfig() {
