 ...
 */
public class SLConfigurableExtensionBuilder<T extends ConfigurableExtensionRuntime<? extends V>, V extends ExtensionConfig> extends OSGiConfigurableExtensionBuilder<T, V> {
