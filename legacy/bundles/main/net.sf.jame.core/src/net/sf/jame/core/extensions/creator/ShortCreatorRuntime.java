 ...
 */
public class ShortCreatorRuntime extends CreatorExtensionRuntime {
	/**
	...
	public Object create(final Object... args) throws JSException {
		try {
			return new Short(((Double) args[0]).shortValue());
		}
		catch (Exception e) {
			throw new JSException("Short creator requires one arguments: #1 of type Number", e);
		}
	}
}
