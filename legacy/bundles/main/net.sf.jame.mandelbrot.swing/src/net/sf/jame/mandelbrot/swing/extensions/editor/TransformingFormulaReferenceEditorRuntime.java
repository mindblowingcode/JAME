 ...
 */
public class TransformingFormulaReferenceEditorRuntime extends ConfigurableReferenceEditorRuntime {
	/**
	...
	protected ConfigurableExtensionComboBoxModel createModel() {
		return new ConfigurableExtensionComboBoxModel(MandelbrotRegistry.getInstance().getTransformingFormulaRegistry(), true);
	}
	...
	protected NodeValue createNodeValue(final ConfigurableExtensionReference reference) {
		// return new TransformingFormulaExtensionReferenceNodeValue(reference != null ? reference.clone() : null);
		return new TransformingFormulaExtensionReferenceNodeValue(reference);
	}
}
