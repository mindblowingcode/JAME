 ...
 */
public class TargetAlphaPathAdjustmentConfig extends PathAdjustmentExtensionConfig {
	...
	public boolean equals(final Object obj) {
		...
		final TargetAlphaPathAdjustmentConfig other = (TargetAlphaPathAdjustmentConfig) obj;
	 ...
	 */
	@Override
	public TargetAlphaPathAdjustmentConfig clone() {
		final TargetAlphaPathAdjustmentConfig config = new TargetAlphaPathAdjustmentConfig();
