 ...
 */
public class BooleanNodeActionXMLExporterRuntime extends AbstractActionXMLExporterRuntime {
	/**
	...
	protected void exportParams(final NodeActionValue action, final Element element, final XMLNodeBuilder builder) throws XMLExportException {
		final BooleanElementXMLExporter exporter = new BooleanElementXMLExporter();
		final BooleanElement configElement0 = new BooleanElement((Boolean) action.getActionParams()[0]);
		final BooleanElement configElement1 = new BooleanElement((Boolean) action.getActionParams()[1]);
