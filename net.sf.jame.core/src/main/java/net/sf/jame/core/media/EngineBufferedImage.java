...
class EngineBufferedImage implements EngineImage {
	...
	/**
	 * @see net.sf.jame.core.media.EngineImage#clone()
	 */
	@Override
	...
	/**
	 * @see net.sf.jame.core.media.EngineImage#applyEffect(net.sf.jame.core.media.Effect)
	 */
	...
	/**
	 * @see net.sf.jame.core.media.EngineImage#drawImage(java.awt.Graphics2D)
	 */
	...
	/**
	 * @see net.sf.jame.core.media.EngineImage#getWidth()
	 */
	public int getWidth() {
	...
	/**
	 * @see net.sf.jame.core.media.EngineImage#getHeight()
	 */
	...
	/**
	 * @see net.sf.jame.core.media.EngineImage#update()
	 */
	public void update() {
