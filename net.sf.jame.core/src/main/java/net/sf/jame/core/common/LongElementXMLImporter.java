 ...
 */
public class LongElementXMLImporter extends ValueConfigElementXMLImporter<Long, LongElement> {
	/**
	 ...
	 */
	@Override
	protected LongElement createDefaultConfigElement() {
		return new LongElement((long) 0);
	}
}
