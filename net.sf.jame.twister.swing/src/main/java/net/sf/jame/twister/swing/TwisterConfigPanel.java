...
import net.sf.jame.twister.layer.LayerConfigElement;
...
public class TwisterConfigPanel extends ViewPanel {
	...
	private class RenderTask implements RenderContextListener {
		...
		/**
		 * @see net.sf.jame.core.util.RenderContextListener#startRenderer()
		 */
		...
		/**
		 * @see net.sf.jame.core.util.RenderContextListener#stopRenderer()
		 */
		...
		/**
		 * @see net.sf.jame.core.util.RenderContextListener#joinRenderer()
		 */
		...
		/**
		 * @see net.sf.jame.core.util.RenderContextListener#abortRenderer()
		 */
		...
		/**
		 * @see net.sf.jame.core.util.RenderContextListener#refresh()
		 */
		public void refresh() {
