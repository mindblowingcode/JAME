...
public class DummyRemoteJob implements DistributedSpoolJobInterface {
	...
	/**
	 * @see net.sf.jame.queue.spool.JobInterface#setFrameNumber(int)
	 */
	...
	/**
	 * @see net.sf.jame.queue.spool.JobInterface#setFirstFrameNumber(int)
	 */
	...
	/**
	 * @see net.sf.jame.queue.spool.DistributedSpoolJobInterface#getRemoteJobId()
	 */
	...
	/**
	 * @see net.sf.jame.queue.spool.DistributedSpoolJobInterface#setRemoteJobId(java.lang.String)
	 */
	...
	/**
	 * @see net.sf.jame.queue.spool.SpoolJobInterface#getJobDataRow()
	 */
	...
	/**
	 * @see net.sf.jame.queue.spool.SpoolJobInterface#setJobDataRow(JobData)
	 */
	...
	/**
	 * @see net.sf.jame.queue.spool.DistributedSpoolJobInterface#getRAF()
	 */
	...
	/**
	 * @see net.sf.jame.queue.spool.DistributedSpoolJobInterface#getTotalFrames()
	 */
	...
	/**
	 * @see net.sf.jame.queue.spool.DistributedSpoolJobInterface#setTerminated(boolean)
	 */
