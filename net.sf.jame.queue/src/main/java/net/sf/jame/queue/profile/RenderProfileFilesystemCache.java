...
import net.sf.jame.queue.DefaultFilesystemCache;
import net.sf.jame.queue.io.ChunkedFileInputStream;
 ...
 */
public class RenderProfileFilesystemCache extends DefaultFilesystemCache {
	 ...
	 * @throws IOException
	 */
	public RenderProfileFilesystemCache(final File workdir) throws IOException {
		super(workdir);
	}
