...
public class DefaultJobService<T extends JobInterface> implements JobService<T> {
	...
	private class ServiceJobListener implements JobListener {
		...
		/**
		 * @see net.sf.jame.queue.spool.JobListener#updated(java.lang.String, net.sf.jame.queue.spool.JobData)
		 */
		...
		/**
		 * @see net.sf.jame.queue.spool.JobListener#started(java.lang.String, net.sf.jame.queue.spool.JobData)
		 */
		...
		/**
		 * @see net.sf.jame.queue.spool.JobListener#stopped(java.lang.String, net.sf.jame.queue.spool.JobData)
		 */
		...
		/**
		 * @see net.sf.jame.queue.spool.JobListener#terminated(java.lang.String, net.sf.jame.queue.spool.JobData)
		 */
		...
		/**
		 * @see net.sf.jame.queue.spool.JobListener#disposed(java.lang.String, net.sf.jame.queue.spool.JobData)
		 */
