 ...
 *
 */
package net.sf.jame.queue.profile;
...
public final class RenderProfileDataRow implements Serializable {
	...
	/**
	 * @return
	 * @see net.sf.jame.queue.profile.RenderProfile#getClipName()
	 */
	...
	/**
	 * @return
	 * @see net.sf.jame.queue.profile.RenderProfile#getFrameRate()
	 */
	...
	/**
	 * @return
	 * @see net.sf.jame.queue.profile.RenderProfile#getImageHeight()
	 */
	...
	/**
	 * @return
	 * @see net.sf.jame.queue.profile.RenderProfile#getImageWidth()
	 */
	...
	/**
	 * @return
	 * @see net.sf.jame.queue.profile.RenderProfile#getOffsetX()
	 */
	...
	/**
	 * @return
	 * @see net.sf.jame.queue.profile.RenderProfile#getOffsetY()
	 */
	...
	/**
	 * @return
	 * @see net.sf.jame.queue.profile.RenderProfile#getProfileName()
	 */
	...
	/**
	 * @return
	 * @see net.sf.jame.queue.profile.RenderProfile#getQuality()
	 */
	...
	/**
	 * @return
	 * @see net.sf.jame.queue.profile.RenderProfile#getStartTime()
	 */
	...
	/**
	 * @return
	 * @see net.sf.jame.queue.profile.RenderProfile#getStopTime()
	 */
	...
	/**
	 * @param clipName
	 * @see net.sf.jame.queue.profile.RenderProfile#setClipName(java.lang.String)
	 */
	...
	/**
	 * @param frameRate
	 * @see net.sf.jame.queue.profile.RenderProfile#setFrameRate(int)
	 */
	...
	/**
	 * @param height
	 * @see net.sf.jame.queue.profile.RenderProfile#setImageHeight(int)
	 */
	...
	/**
	 * @param width
	 * @see net.sf.jame.queue.profile.RenderProfile#setImageWidth(int)
	 */
	...
	/**
	 * @param offsetX
	 * @see net.sf.jame.queue.profile.RenderProfile#setOffsetX(int)
	 */
	...
	/**
	 * @param offsetY
	 * @see net.sf.jame.queue.profile.RenderProfile#setOffsetY(int)
	 */
	...
	/**
	 * @param profileName
	 * @see net.sf.jame.queue.profile.RenderProfile#setProfileName(java.lang.String)
	 */
	...
	/**
	 * @param quality
	 * @see net.sf.jame.queue.profile.RenderProfile#setQuality(int)
	 */
	...
	/**
	 * @param startTime
	 * @see net.sf.jame.queue.profile.RenderProfile#setStartTime(int)
	 */
	...
	/**
	 * @param stopTime
	 * @see net.sf.jame.queue.profile.RenderProfile#setStopTime(int)
	 */
