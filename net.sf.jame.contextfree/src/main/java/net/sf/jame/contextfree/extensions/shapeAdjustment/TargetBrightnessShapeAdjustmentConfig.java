 ...
 */
public class TargetBrightnessShapeAdjustmentConfig extends ShapeAdjustmentExtensionConfig {
	...
	public boolean equals(final Object obj) {
		...
		final TargetBrightnessShapeAdjustmentConfig other = (TargetBrightnessShapeAdjustmentConfig) obj;
	 ...
	 */
	@Override
	public TargetBrightnessShapeAdjustmentConfig clone() {
		final TargetBrightnessShapeAdjustmentConfig config = new TargetBrightnessShapeAdjustmentConfig();
