 ...
 */
public class YShapeAdjustmentConfigNodeBuilderRuntime extends NodeBuilderExtensionRuntime {
	/**
	...
	public NodeBuilder createNodeBuilder(final ExtensionConfig config) {
		return new ConfigNodeBuilder((YShapeAdjustmentConfig) config);
	}

	private class ConfigNodeBuilder extends AbstractExtensionConfigNodeBuilder<YShapeAdjustmentConfig> {
		/**
		 * @param config
		 */
		public ConfigNodeBuilder(final YShapeAdjustmentConfig config) {
			super(config);
		}
		...
		private class ValueElementNode extends FloatElementNode {
			 ...
			 * @param config
			 */
			public ValueElementNode(final YShapeAdjustmentConfig config) {
