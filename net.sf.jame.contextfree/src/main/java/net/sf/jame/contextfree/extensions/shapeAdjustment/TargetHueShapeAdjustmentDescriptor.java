...
import net.sf.jame.contextfree.extensions.shapeAdjustment.TargetHueShapeAdjustmentRuntime;
import net.sf.jame.contextfree.extensions.shapeAdjustment.TargetHueShapeAdjustmentConfig;

/**
 * @author Andrea Medeghini
 */
public class TargetHueShapeAdjustmentDescriptor extends ShapeAdjustmentExtensionDescriptor {
	/**
