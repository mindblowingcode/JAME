 ...
 */
public class PathAdjustmentCreatorDescriptor extends CreatorExtensionDescriptor {
	/**
	 ...
	 */
	public PathAdjustmentCreatorRuntime getExtensionRuntime() {
		return new PathAdjustmentCreatorRuntime();
	}
}
