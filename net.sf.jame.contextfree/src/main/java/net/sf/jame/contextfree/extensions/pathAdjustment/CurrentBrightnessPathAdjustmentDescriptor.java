...
import net.sf.jame.contextfree.extensions.pathAdjustment.CurrentBrightnessPathAdjustmentRuntime;
import net.sf.jame.contextfree.extensions.pathAdjustment.CurrentBrightnessPathAdjustmentConfig;

/**
 * @author Andrea Medeghini
 */
public class CurrentBrightnessPathAdjustmentDescriptor extends PathAdjustmentExtensionDescriptor {
	/**
	 ...
	 */
	public CurrentBrightnessPathAdjustmentRuntime getExtensionRuntime() {
		return new CurrentBrightnessPathAdjustmentRuntime();
	}
	 ...
	 */
	public CurrentBrightnessPathAdjustmentConfig getExtensionConfig() {
