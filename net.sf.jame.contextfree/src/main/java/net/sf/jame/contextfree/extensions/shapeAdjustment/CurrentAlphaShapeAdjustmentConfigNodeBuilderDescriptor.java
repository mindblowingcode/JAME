...
import net.sf.jame.contextfree.extensions.shapeAdjustment.CurrentAlphaShapeAdjustmentConfigNodeBuilderRuntime;

/**
 * @author Andrea Medeghini
 */
public class CurrentAlphaShapeAdjustmentConfigNodeBuilderDescriptor extends NodeBuilderExtensionDescriptor {
	/**
