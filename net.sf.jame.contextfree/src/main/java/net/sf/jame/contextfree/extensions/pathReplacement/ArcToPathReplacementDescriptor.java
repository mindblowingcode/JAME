 ...
 */
public class ArcToPathReplacementDescriptor extends PathReplacementExtensionDescriptor {
	/**
	 ...
	 */
	public ArcToPathReplacementRuntime getExtensionRuntime() {
		return new ArcToPathReplacementRuntime();
	}
	 ...
	 */
	public ArcToPathReplacementConfig getExtensionConfig() {
