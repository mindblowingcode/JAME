 ...
 */
public class TargetBrightnessShapeAdjustmentConfigNodeBuilderRuntime extends NodeBuilderExtensionRuntime {
	/**
	...
	public NodeBuilder createNodeBuilder(final ExtensionConfig config) {
		return new ConfigNodeBuilder((TargetBrightnessShapeAdjustmentConfig) config);
	}

	private class ConfigNodeBuilder extends AbstractExtensionConfigNodeBuilder<TargetBrightnessShapeAdjustmentConfig> {
		/**
		 * @param config
		 */
		public ConfigNodeBuilder(final TargetBrightnessShapeAdjustmentConfig config) {
			super(config);
		}
		...
		private class ValueElementNode extends FloatElementNode {
			 ...
			 * @param config
			 */
			public ValueElementNode(final TargetBrightnessShapeAdjustmentConfig config) {
