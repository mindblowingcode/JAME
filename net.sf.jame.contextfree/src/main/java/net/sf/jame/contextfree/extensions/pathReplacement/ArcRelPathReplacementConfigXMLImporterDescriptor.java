 ...
 */
public class ArcRelPathReplacementConfigXMLImporterDescriptor extends ExtensionConfigXMLImporterExtensionDescriptor {
	/**
	 ...
	 */
	public ArcRelPathReplacementConfigXMLImporterRuntime getExtensionRuntime() {
		return new ArcRelPathReplacementConfigXMLImporterRuntime();
	}
}
