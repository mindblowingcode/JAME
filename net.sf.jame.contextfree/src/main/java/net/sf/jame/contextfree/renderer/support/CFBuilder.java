...
public class CFBuilder {
	...
	public CFBuilder(CFContext context) {
		this.context = context;
	}
	
	public int encodeShapeName(String shapeName) {
		return context.encodeShapeName(shapeName);
	}
	...
	public int getLoopEndShapeType() {
		return context.getLoopEndShapeType();
	}

	public int getLoopStartShapeType() {
		return context.getLoopStartShapeType();
	}
}
