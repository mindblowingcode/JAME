...
import net.sf.jame.contextfree.extensions.shapeAdjustment.CurrentBrightnessShapeAdjustmentRuntime;
import net.sf.jame.contextfree.extensions.shapeAdjustment.CurrentBrightnessShapeAdjustmentConfig;

/**
 * @author Andrea Medeghini
 */
public class CurrentBrightnessShapeAdjustmentDescriptor extends ShapeAdjustmentExtensionDescriptor {
	/**
