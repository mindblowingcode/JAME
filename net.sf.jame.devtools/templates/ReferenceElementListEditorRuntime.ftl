...
public class <#if parentRuntimeClass?exists>${extension.elementName?cap_first}ReferenceElementListEditorRuntime extends ${parentRuntimeClass}<#else>${extension.elementName?cap_first}ReferenceElementListEditorRuntime extends ReferenceElementListEditorRuntime</#if> {
	/**
	 * @see net.sf.jame.core.swing.editor.ReferenceElementListEditorRuntime#createModel()
	 */
	@Override
	...
	/**
	 * @see net.sf.jame.core.swing.editor.ReferenceElementListEditorRuntime#createNodeValue(net.sf.jame.core.extension.ExtensionReference)
	 */
	...
	/**
	 * @see net.sf.jame.core.swing.editor.ReferenceElementListEditorRuntime#getAppendLabel()
	 */
	@Override
	...
	/**
	 * @see net.sf.jame.core.swing.editor.ReferenceElementListEditorRuntime#getRemoveAllLabel()
	 */
	@Override
	...
	/**
	 * @see net.sf.jame.core.swing.editor.ReferenceElementListEditorRuntime#getAppendTooltip()
	 */
	@Override
	...
	/**
	 * @see net.sf.jame.core.swing.editor.ReferenceElementListEditorRuntime#getRemoveAllTooltip()
	 */
	@Override
