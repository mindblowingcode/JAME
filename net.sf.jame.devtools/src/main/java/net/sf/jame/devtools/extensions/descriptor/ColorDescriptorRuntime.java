...
public class ColorDescriptorRuntime extends DescriptorExtensionRuntime {
	...
	public ProcessorDescriptor createDescriptor(String elementName, String defaultValue, ProcessorCardinality cardinality) {
		return new ProcessorDescriptor(elementName, "Color", ColorElement.CLASS_ID, "net.sf.jame.core.common", "ColorElement", null, null, null, null, null, null, null, null, null, null, null, null, "net.sf.jame.core.util", "Color32bit", defaultValue, "get", "set", cardinality);
	}
