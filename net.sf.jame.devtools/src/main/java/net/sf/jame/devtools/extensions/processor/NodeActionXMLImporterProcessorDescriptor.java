...
import net.sf.jame.devtools.extensions.processor.NodeActionXMLImporterProcessorRuntime;

/**
 * @author Andrea Medeghini
 */
public class NodeActionXMLImporterProcessorDescriptor extends ProcessorExtensionDescriptor {
	/**
