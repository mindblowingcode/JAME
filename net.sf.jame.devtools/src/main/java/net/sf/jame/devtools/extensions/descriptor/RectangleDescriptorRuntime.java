...
public class RectangleDescriptorRuntime extends DescriptorExtensionRuntime {
	...
	public ProcessorDescriptor createDescriptor(String elementName, String defaultValue, ProcessorCardinality cardinality) {
		return new ProcessorDescriptor(elementName, "Rectangle", RectangleElement.CLASS_ID, "net.sf.jame.core.common", "RectangleElement", null, null, null, null, null, null, null, null, null, null, null, null, "net.sf.jame.core.util", "Rectangle", defaultValue, "get", "set", cardinality);
	}
	...
	public String getClassId() {
		return RectangleElement.CLASS_ID;
	}
}
