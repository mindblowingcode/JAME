...
public class DoubleDescriptorRuntime extends DescriptorExtensionRuntime {
	...
	public ProcessorDescriptor createDescriptor(String elementName, String defaultValue, ProcessorCardinality cardinality) {
		return new ProcessorDescriptor(elementName, "Double", DoubleElement.CLASS_ID, "net.sf.jame.core.common", "DoubleElement", null, null, null, null, null, null, null, null, null, null, null, null, "java.lang", "Double", defaultValue, "get", "set", cardinality);
	}
