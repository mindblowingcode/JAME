...
import net.sf.jame.mandelbrot.swing.extensions.inputAdapter.MandelbrotInputAdapterRuntime;

/**
 * @author Andrea Medeghini
 */
public class MandelbrotInputAdapterDescriptor extends InputAdapterExtensionDescriptor {
	/**
